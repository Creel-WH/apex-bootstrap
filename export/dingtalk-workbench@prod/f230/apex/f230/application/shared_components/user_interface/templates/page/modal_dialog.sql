...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421775897077171845)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421776228851171845)
,p_page_template_id=>wwv_flow_imp.id(4421775897077171845)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421776556175171845)
,p_page_template_id=>wwv_flow_imp.id(4421775897077171845)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421776811922171845)
,p_page_template_id=>wwv_flow_imp.id(4421775897077171845)
