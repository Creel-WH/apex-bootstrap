...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421758824372171838)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421759169424171838)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421759449823171838)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421759687930171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421759989933171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421760303048171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421760629960171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421760971754171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421761266495171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421761549672171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421761826664171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421762138604171839)
,p_page_template_id=>wwv_flow_imp.id(4421758824372171838)
