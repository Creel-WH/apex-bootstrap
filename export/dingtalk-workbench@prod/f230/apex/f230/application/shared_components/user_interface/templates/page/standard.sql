...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421762486963171839)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421762839222171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421763169822171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421763398296171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421763708598171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421764079017171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421764340309171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421764589626171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421764931666171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421765273364171840)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421765514616171841)
,p_page_template_id=>wwv_flow_imp.id(4421762486963171839)
