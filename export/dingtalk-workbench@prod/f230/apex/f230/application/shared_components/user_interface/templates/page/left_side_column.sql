...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421755169914171835)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421755387753171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421755741714171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421756071997171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421756348684171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421756604649171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421756904632171836)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421757184135171837)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421757549224171837)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421757879003171837)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421758139880171837)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421758406303171837)
,p_page_template_id=>wwv_flow_imp.id(4421755169914171835)
