...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421806473195171861)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421806697443171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421807043596171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421807367047171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421807634472171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421807945523171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421808195830171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421808574983171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421808794652171862)
,p_plug_template_id=>wwv_flow_imp.id(4421806473195171861)
,p_name=>'Sub Regions'
