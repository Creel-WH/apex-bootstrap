...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421834952242171872)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421835265643171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421835541128171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421835863493171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421836152758171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421836413775171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421836757117171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421837018455171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421837347433171873)
,p_plug_template_id=>wwv_flow_imp.id(4421834952242171872)
,p_name=>'Sub Regions'
