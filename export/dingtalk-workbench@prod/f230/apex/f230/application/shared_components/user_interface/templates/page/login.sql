...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421773381336171844)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421773644925171844)
,p_page_template_id=>wwv_flow_imp.id(4421773381336171844)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421773929691171844)
,p_page_template_id=>wwv_flow_imp.id(4421773381336171844)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421774236851171844)
,p_page_template_id=>wwv_flow_imp.id(4421773381336171844)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421774557361171844)
,p_page_template_id=>wwv_flow_imp.id(4421773381336171844)
,p_name=>'Body Footer'
