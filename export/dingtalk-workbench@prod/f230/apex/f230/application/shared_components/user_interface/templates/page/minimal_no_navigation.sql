...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4421769959998171842)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421770203550171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421770573773171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421770802157171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421771092062171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421771460230171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421771768187171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421772082658171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421772324138171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421772643486171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421772953877171843)
,p_page_template_id=>wwv_flow_imp.id(4421769959998171842)
