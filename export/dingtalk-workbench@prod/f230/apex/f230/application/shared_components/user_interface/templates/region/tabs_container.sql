...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421864486337171884)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421864830670171884)
,p_plug_template_id=>wwv_flow_imp.id(4421864486337171884)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421865157498171884)
,p_plug_template_id=>wwv_flow_imp.id(4421864486337171884)
,p_name=>'Tabs'
