...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421801051197171860)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421801357361171860)
,p_plug_template_id=>wwv_flow_imp.id(4421801051197171860)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421801676193171860)
,p_plug_template_id=>wwv_flow_imp.id(4421801051197171860)
,p_name=>'Sub Regions'
