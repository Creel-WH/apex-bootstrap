...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421831437085171871)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421831688211171871)
,p_plug_template_id=>wwv_flow_imp.id(4421831437085171871)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421832053837171871)
,p_plug_template_id=>wwv_flow_imp.id(4421831437085171871)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421832296396171871)
,p_plug_template_id=>wwv_flow_imp.id(4421831437085171871)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421832631760171872)
,p_plug_template_id=>wwv_flow_imp.id(4421831437085171871)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421832905080171872)
,p_plug_template_id=>wwv_flow_imp.id(4421831437085171871)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
