...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421847035526171877)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421847378579171877)
,p_plug_template_id=>wwv_flow_imp.id(4421847035526171877)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421847634663171877)
,p_plug_template_id=>wwv_flow_imp.id(4421847035526171877)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421847953151171877)
,p_plug_template_id=>wwv_flow_imp.id(4421847035526171877)
,p_name=>'Button Start'
