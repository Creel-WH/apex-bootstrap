...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421872223600171886)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421872559783171887)
,p_plug_template_id=>wwv_flow_imp.id(4421872223600171886)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421872865901171887)
,p_plug_template_id=>wwv_flow_imp.id(4421872223600171886)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421873088327171887)
,p_plug_template_id=>wwv_flow_imp.id(4421872223600171886)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421873444663171887)
,p_plug_template_id=>wwv_flow_imp.id(4421872223600171886)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421873701240171887)
,p_plug_template_id=>wwv_flow_imp.id(4421872223600171886)
