...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421821605687171867)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421821949307171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421822253333171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421822511322171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421822790470171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421823151897171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421823421538171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421823691039171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421824069865171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421824376852171868)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421824614455171869)
,p_plug_template_id=>wwv_flow_imp.id(4421821605687171867)
,p_name=>'Sub Regions'
