...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421782970851171849)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421783258660171851)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421783523157171852)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421783836460171852)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421784088702171852)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421784387920171852)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421784741420171852)
,p_plug_template_id=>wwv_flow_imp.id(4421782970851171849)
,p_name=>'Sub Regions'
