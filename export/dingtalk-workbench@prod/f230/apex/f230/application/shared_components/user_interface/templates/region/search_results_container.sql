...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421852054656171879)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421852319305171879)
,p_plug_template_id=>wwv_flow_imp.id(4421852054656171879)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421852607268171879)
,p_plug_template_id=>wwv_flow_imp.id(4421852054656171879)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421852963353171879)
,p_plug_template_id=>wwv_flow_imp.id(4421852054656171879)
,p_name=>'Sub Regions'
