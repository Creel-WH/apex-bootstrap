...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421817040218171866)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421817366491171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421817660423171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421817903006171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421818188275171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421818567943171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421818800480171866)
,p_plug_template_id=>wwv_flow_imp.id(4421817040218171866)
,p_name=>'Sub Regions'
