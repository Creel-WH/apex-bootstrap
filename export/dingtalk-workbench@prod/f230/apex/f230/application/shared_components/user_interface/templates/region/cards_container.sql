...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421815155740171864)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421815447928171865)
,p_plug_template_id=>wwv_flow_imp.id(4421815155740171864)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421815743794171865)
,p_plug_template_id=>wwv_flow_imp.id(4421815155740171864)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421816057858171865)
,p_plug_template_id=>wwv_flow_imp.id(4421815155740171864)
,p_name=>'Sub Regions'
