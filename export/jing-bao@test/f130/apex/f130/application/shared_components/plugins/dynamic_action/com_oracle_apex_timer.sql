...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2275419665968722093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2275420018918722093)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2275420441888722093)
,p_plugin_attribute_id=>wwv_flow_imp.id(2275420018918722093)
,p_display_sequence=>10
,p_display_value=>'Add Timer'
,p_return_value=>'add'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2275420943242722093)
,p_plugin_attribute_id=>wwv_flow_imp.id(2275420018918722093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2275421378387722093)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
,p_attribute_scope=>'COMPONENT'
...
,p_max_length=>20
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(2275420018918722093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2275421803639722093)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2275422245032722093)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2275422583296722094)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2275423002456722094)
,p_plugin_attribute_id=>wwv_flow_imp.id(2275422583296722094)
,p_display_sequence=>10
,p_display_value=>'Once'
,p_return_value=>'once'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2275423488778722094)
,p_plugin_attribute_id=>wwv_flow_imp.id(2275422583296722094)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_event(
 p_id=>wwv_flow_imp.id(2275425178375722096)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2275425636492722096)
,p_plugin_id=>wwv_flow_imp.id(2275419665968722093)
