...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(2304300397060371642)
...
,p_reference_id=>19488318983171028260
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2304300750010371642)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2304301172980371642)
,p_plugin_attribute_id=>wwv_flow_imp.id(2304300750010371642)
,p_display_sequence=>10
,p_display_value=>'Add Timer'
,p_return_value=>'add'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2304301674334371642)
,p_plugin_attribute_id=>wwv_flow_imp.id(2304300750010371642)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2304302109479371642)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
,p_attribute_scope=>'COMPONENT'
...
,p_max_length=>20
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(2304300750010371642)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2304302534731371642)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2304302976124371642)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2304303314388371643)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2304303733548371643)
,p_plugin_attribute_id=>wwv_flow_imp.id(2304303314388371643)
,p_display_sequence=>10
,p_display_value=>'Once'
,p_return_value=>'once'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(2304304219870371643)
,p_plugin_attribute_id=>wwv_flow_imp.id(2304303314388371643)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_event(
 p_id=>wwv_flow_imp.id(2304305909467371645)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2304306367584371645)
,p_plugin_id=>wwv_flow_imp.id(2304300397060371642)
