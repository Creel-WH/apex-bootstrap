...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2286668467433554750)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2148685825215006154)
,p_plug_template_id=>wwv_flow_imp.id(2286668467433554750)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2148685895490006154)
,p_plug_template_id=>wwv_flow_imp.id(2286668467433554750)
,p_name=>'Sub Regions'
