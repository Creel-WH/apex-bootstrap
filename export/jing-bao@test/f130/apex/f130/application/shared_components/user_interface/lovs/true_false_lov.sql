...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2152724894896137509)
,p_lov_name=>'TRUE_FALSE_LOV'
,p_lov_query=>'.'||wwv_flow_imp.id(2152724894896137509)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2152725160739137509)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('\662F')
,p_lov_return_value=>'TRUE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2152725570847137509)
