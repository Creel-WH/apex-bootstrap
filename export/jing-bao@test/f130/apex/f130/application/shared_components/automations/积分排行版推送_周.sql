prompt --application/shared_components/automations/积分排行版推送_周
begin
--   Manifest
--     AUTOMATION: 积分排行版推送-周
--   Manifest End
...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(2182750968393362516)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(2182751307581362516)
,p_automation_id=>wwv_flow_imp.id(2182750968393362516)
,p_name=>unistr('\65B0\5EFA\64CD\4F5C')
,p_execution_sequence=>10
,p_action_type=>'NATIVE_PLSQL'
,p_action_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'    APEX_POINT_SORT_LIST(''WEEK'',1);',
'end;'))
