...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2230737263826279678)
,p_name=>'Authority List'
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2230739894332279679)
,p_list_item_display_sequence=>120
,p_list_item_link_text=>unistr('\89D2\8272\7B56\7565\5206\914D')
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
,p_security_scheme=>wwv_flow_imp.id(2286772242564554824)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'15'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2230740251086279679)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2230741538493279680)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2230742274785279680)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2233225530583553248)
