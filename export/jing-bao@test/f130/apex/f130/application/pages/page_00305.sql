...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(223847693231268287)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(223850213674268313)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223340558112407925)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223340689744407926)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223340738589407927)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223340851554407928)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223340978814407929)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223341089322407930)
,p_name=>'P305_REMARK'
,p_item_sequence=>130
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223341162391407931)
,p_name=>'P305_IMAGES'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(223847693231268287)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223341249737407932)
,p_name=>'P305_EFFECT_MINUTE'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(223850213674268313)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223341298714407933)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(223341664693407936)
,p_name=>'P305_COUNT'
,p_item_sequence=>160
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225976649261571000)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(225976750887571001)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(273360027467592718)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(223340281533407922)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(223340390848407923)
,p_event_id=>wwv_flow_imp.id(223340281533407922)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(223341432590407934)
,p_event_id=>wwv_flow_imp.id(223340281533407922)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(223341537987407935)
,p_event_id=>wwv_flow_imp.id(223340281533407922)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(225976549665570999)
