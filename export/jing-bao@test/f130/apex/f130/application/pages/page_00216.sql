...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2148170978683769060)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2171561081610013712)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2148170978683769060)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2171561182766013713)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2148170978683769060)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2119276180723898930)
,p_name=>'P216_ROW_COUNT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2148170978683769060)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2119276292522898931)
,p_name=>'P216_ERROR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2148170978683769060)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2148171076781769061)
,p_name=>'P216_USER_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2148170978683769060)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2171561993740013721)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2171565510844013756)
,p_name=>'P216_DEPT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2148170978683769060)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2171561285011013714)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2171561182766013713)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2171561404388013715)
,p_event_id=>wwv_flow_imp.id(2171561285011013714)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2171561495173013716)
,p_name=>unistr('\6307\6D3E')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2171561081610013712)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2119276136260898929)
,p_event_id=>wwv_flow_imp.id(2171561495173013716)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2119276448542898932)
,p_event_id=>wwv_flow_imp.id(2171561495173013716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2171561639433013717)
,p_event_id=>wwv_flow_imp.id(2171561495173013716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2171565579094013757)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2171565671605013758)
,p_event_id=>wwv_flow_imp.id(2171565579094013757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
