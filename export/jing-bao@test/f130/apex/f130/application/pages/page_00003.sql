...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2303777982987191827)
...
,p_list_id=>wwv_flow_imp.id(2303900618401927408)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(2359858901291135320)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2310203979866600934)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2224025794355154930)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2224025976050154931)
,p_event_id=>wwv_flow_imp.id(2224025794355154930)
,p_event_result=>'TRUE'
