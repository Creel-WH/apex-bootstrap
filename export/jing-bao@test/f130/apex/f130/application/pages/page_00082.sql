...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2282140549598010207)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2282140943395010208)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2282141328645010208)
,p_query_column_id=>2
,p_column_alias=>'NAME'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2282141712146010208)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2281468378793307586)
,p_name=>'P82_ORG_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2282140549598010207)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2282417822627235787)
,p_name=>'P82_BEGIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2282140549598010207)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2282417926230235788)
,p_name=>'P82_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2282140549598010207)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195286522035950071)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195286611902950072)
,p_event_id=>wwv_flow_imp.id(2195286522035950071)
,p_event_result=>'TRUE'
