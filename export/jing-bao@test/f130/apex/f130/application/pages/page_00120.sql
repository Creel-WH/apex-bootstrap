...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2227891296067492414)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2227891761505492416)
,p_region_id=>wwv_flow_imp.id(2227891296067492414)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2227892209319492416)
,p_chart_id=>wwv_flow_imp.id(2227891761505492416)
,p_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2227892875794493110)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2229978164104863041)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2227893173369493113)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(2227892875794493110)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2227892943378493111)
,p_name=>'P120_BEGIN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2227892875794493110)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2227893083844493112)
,p_name=>'P120_END'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2227892875794493110)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2234506941786231240)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2234506992995231241)
,p_event_id=>wwv_flow_imp.id(2234506941786231240)
,p_event_result=>'TRUE'
