...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2238176622540304799)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2238480206686541468)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2238480637393541468)
,p_region_id=>wwv_flow_imp.id(2238480206686541468)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2238481073815541468)
,p_chart_id=>wwv_flow_imp.id(2238480637393541468)
,p_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2238176890346304802)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(2238176622540304799)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2238176674276304800)
,p_name=>'P78_BEGIN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2238176622540304799)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2238176802094304801)
,p_name=>'P78_END'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2238176622540304799)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2151045476100019085)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2151045590962019086)
,p_event_id=>wwv_flow_imp.id(2151045476100019085)
,p_event_result=>'TRUE'
