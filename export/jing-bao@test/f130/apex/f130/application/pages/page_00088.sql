...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2229977639403863036)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2311299616482885347)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2316004682163361315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2311299491152885346)
,p_plug_name=>unistr('\56FE\8868')
,p_parent_plug_id=>wwv_flow_imp.id(2316004682163361315)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2311300032992885351)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(2311299616482885347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2311299789112885348)
,p_name=>'P88_BEGIN_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2311299616482885347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2311299860056885349)
,p_name=>'P88_END_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2311299616482885347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2311299903961885350)
,p_name=>'P88_FAB'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2311299616482885347)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2224028660168154958)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2224028697173154959)
,p_event_id=>wwv_flow_imp.id(2224028660168154958)
,p_event_result=>'TRUE'
