...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168174469168170260)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168174862961170261)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2179843092593395676)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168175294199170261)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2168193517592170278)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129132872581338)
,p_name=>'P161_EVENT_LIBRARY_SOLVING_ASSO_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(2179843092593395676)
,p_item_source_plug_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129267649581339)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129352406581340)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129470446581341)
,p_name=>'P161_SUMMARY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129617148581342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129691440581343)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129772668581344)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168129847399581345)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168130015673581346)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168130088926581347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168176875391170262)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168177257465170263)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168177721020170263)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168178035464170263)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168178496067170263)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168179310299170263)
,p_name=>'P161_CONTENT'
,p_source_data_type=>'CLOB'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168180500717170264)
,p_name=>'P161_REMARK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168180869000170264)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168181253563170264)
,p_name=>'161_APP_KEY'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(2179843092593395676)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168181694542170264)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168192456006170278)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168193021342170278)
,p_event_id=>wwv_flow_imp.id(2168192456006170278)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168191578504170277)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168192111029170278)
,p_event_id=>wwv_flow_imp.id(2168191578504170277)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168189212258170276)
,p_name=>unistr('\4FDD\5B58')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168175294199170261)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168190665577170277)
,p_event_id=>wwv_flow_imp.id(2168189212258170276)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168191202636170277)
,p_event_id=>wwv_flow_imp.id(2168189212258170276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168190128776170277)
,p_event_id=>wwv_flow_imp.id(2168189212258170276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168189638785170276)
,p_event_id=>wwv_flow_imp.id(2168189212258170276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168186817004170275)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168174862961170261)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168188781600170276)
,p_event_id=>wwv_flow_imp.id(2168186817004170275)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168188270575170276)
,p_event_id=>wwv_flow_imp.id(2168186817004170275)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168187750315170275)
,p_event_id=>wwv_flow_imp.id(2168186817004170275)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168187297096170275)
,p_event_id=>wwv_flow_imp.id(2168186817004170275)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2168186339767170268)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2179843092593395676)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2168185954913170267)
,p_process_sequence=>10
