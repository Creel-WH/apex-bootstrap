...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2171823801531010159)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2171824380299010160)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2171824827382010160)
,p_region_id=>wwv_flow_imp.id(2171824380299010160)
,p_chart_type=>'bar'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2171826511861010161)
,p_chart_id=>wwv_flow_imp.id(2171824827382010160)
,p_seq=>10
,p_name=>unistr('\7EBF\522B\5F02\5E38\5206\5E03')
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2171825318819010161)
,p_chart_id=>wwv_flow_imp.id(2171824827382010160)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2171825921136010161)
,p_chart_id=>wwv_flow_imp.id(2171824827382010160)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161086640844089780)
,p_name=>'P213_BEGIN'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161086742225089781)
,p_name=>'P213_END'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161086878290089782)
,p_name=>'P213_FAB'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161086980198089783)
,p_name=>'P213_TYPE'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161087050374089784)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2161087230434089785)
,p_name=>'P213_OPID'
,p_item_sequence=>70
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
