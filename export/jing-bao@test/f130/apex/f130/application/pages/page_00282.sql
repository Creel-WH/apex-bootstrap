...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(960100261262120234)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(633211597323895773)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_imp.id(960100261262120234)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(633212033234895772)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(874901964960665826)
,p_name=>'P282_FORM_ID_1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(960100261262120234)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(874902072904665827)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(874904501947665821)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103114461120245)
,p_name=>'P282_USER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(960100261262120234)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103332084120247)
,p_name=>'P282_FAB_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(960100261262120234)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103419478120248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103512479120249)
,p_name=>'P282_FORM_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(960100261262120234)
,p_item_default=>'select listagg(FORM_ID,'':'') from CHECK_RULE_FORM_ASSO where CONFIG_ID =:P282_CONFIG_ID;'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103593607120250)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103733922120251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(960103813675120252)
,p_name=>'P282_RULE_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(960100261262120234)
,p_item_default=>'select listagg(RULE_ID,'':'') from CHECK_RULE_USER_ASSO where CONFIG_ID =:P282_CONFIG_ID;'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(961320270666824122)
,p_name=>'P282_COUNT'
,p_item_sequence=>70
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633215901419895769)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(633211597323895773)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633216438866895769)
,p_event_id=>wwv_flow_imp.id(633215901419895769)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633216849265895769)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(633212033234895772)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633217312370895768)
,p_event_id=>wwv_flow_imp.id(633216849265895769)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633217778183895768)
,p_event_id=>wwv_flow_imp.id(633216849265895769)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633218303180895768)
,p_event_id=>wwv_flow_imp.id(633216849265895769)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633218800639895767)
,p_event_id=>wwv_flow_imp.id(633216849265895769)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633219243957895767)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633219708376895767)
,p_event_id=>wwv_flow_imp.id(633219243957895767)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
