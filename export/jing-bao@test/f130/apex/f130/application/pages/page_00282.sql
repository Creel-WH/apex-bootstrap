...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(886977712785539691)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(560089048847315230)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_imp.id(886977712785539691)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(560089484758315229)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(801779416484085283)
,p_name=>'P282_FORM_ID_1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(886977712785539691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(801779524428085284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(801781953471085278)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886980565984539702)
,p_name=>'P282_USER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(886977712785539691)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886980783607539704)
,p_name=>'P282_FAB_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(886977712785539691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886980871001539705)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886980964002539706)
,p_name=>'P282_FORM_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(886977712785539691)
,p_item_default=>'select listagg(FORM_ID,'':'') from CHECK_RULE_FORM_ASSO where CONFIG_ID =:P282_CONFIG_ID;'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886981045130539707)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886981185445539708)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(886981265198539709)
,p_name=>'P282_RULE_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(886977712785539691)
,p_item_default=>'select listagg(RULE_ID,'':'') from CHECK_RULE_USER_ASSO where CONFIG_ID =:P282_CONFIG_ID;'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(888197722190243579)
,p_name=>'P282_COUNT'
,p_item_sequence=>70
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(560093352943315226)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(560089048847315230)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560093890390315226)
,p_event_id=>wwv_flow_imp.id(560093352943315226)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(560094300789315226)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(560089484758315229)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560094763894315225)
,p_event_id=>wwv_flow_imp.id(560094300789315226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560095229707315225)
,p_event_id=>wwv_flow_imp.id(560094300789315226)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560095754704315225)
,p_event_id=>wwv_flow_imp.id(560094300789315226)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560096252163315224)
,p_event_id=>wwv_flow_imp.id(560094300789315226)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(560096695481315224)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(560097159900315224)
,p_event_id=>wwv_flow_imp.id(560096695481315224)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
