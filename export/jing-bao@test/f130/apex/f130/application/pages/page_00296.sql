...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(294808063905882893)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(294815500627882900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(294815880942882901)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(294815500627882900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(294818101171882902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(284689260220753953)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294808522425882893)
,p_name=>'P296_ITEM_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(294808063905882893)
,p_item_source_plug_id=>wwv_flow_imp.id(294808063905882893)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294808933818882895)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294809323737882896)
,p_name=>'P296_NAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294809708476882896)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294810136130882897)
,p_name=>'P296_REMARKS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(294808063905882893)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294810516905882897)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294810915670882897)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294811270948882898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294811684953882898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294812055645882898)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(294815951943882901)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(294815880942882901)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(294816824104882902)
,p_event_id=>wwv_flow_imp.id(294815951943882901)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(284689023070753950)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(294818101171882902)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689109784753951)
,p_event_id=>wwv_flow_imp.id(284689023070753950)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(295071534772615357)
,p_event_id=>wwv_flow_imp.id(284689023070753950)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689176538753952)
,p_event_id=>wwv_flow_imp.id(284689023070753950)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689474788753955)
,p_event_id=>wwv_flow_imp.id(284689023070753950)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689585350753956)
,p_event_id=>wwv_flow_imp.id(284689023070753950)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(284689803195753958)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689911784753959)
,p_event_id=>wwv_flow_imp.id(284689803195753958)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(295072113823615363)
,p_event_id=>wwv_flow_imp.id(284689803195753958)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284689958530753960)
,p_event_id=>wwv_flow_imp.id(284689803195753958)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284690048058753961)
,p_event_id=>wwv_flow_imp.id(284689803195753958)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284690164531753962)
,p_event_id=>wwv_flow_imp.id(284689803195753958)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(284690322501753963)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(284690444362753964)
,p_event_id=>wwv_flow_imp.id(284690322501753963)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294818885387882903)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(294808063905882893)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294819247689882903)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(294818511799882902)
,p_process_sequence=>10
