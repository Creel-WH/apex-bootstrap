...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2169919334225017256)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168499862847060008)
,p_button_sequence=>150
,p_button_plug_id=>wwv_flow_imp.id(2169919334225017256)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168499979985060009)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(555025333147196880)
,p_name=>'P179_CREATED_BY'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(2169919334225017256)
,p_item_source_plug_id=>wwv_flow_imp.id(2169919334225017256)
,p_source=>'CREATED_BY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(555025508453196881)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(555025552771196882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(555025706531196883)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(555025765494196884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168499748488060007)
,p_name=>'P179_REMARK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169919675707017256)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169922526120017252)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169922891781017252)
,p_name=>'P179_MINUTES'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(2169919334225017256)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169923265266017251)
,p_name=>'P179_TIMES'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169923687934017251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169924051673017251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2169973411637946070)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168500058061060010)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168499979985060009)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168500210315060011)
,p_event_id=>wwv_flow_imp.id(2168500058061060010)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168500251273060012)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168499862847060008)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168500370940060013)
,p_event_id=>wwv_flow_imp.id(2168500251273060012)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168500710979060016)
,p_event_id=>wwv_flow_imp.id(2168500251273060012)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2169973125140946067)
,p_event_id=>wwv_flow_imp.id(2168500251273060012)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168500481957060014)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168500585245060015)
,p_event_id=>wwv_flow_imp.id(2168500481957060014)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2169973210455946068)
,p_event_id=>wwv_flow_imp.id(2168500481957060014)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2169973266752946069)
,p_event_id=>wwv_flow_imp.id(2168500481957060014)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2169931529663017245)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2169919334225017256)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2169931927005017245)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2169931091708017246)
,p_process_sequence=>10
