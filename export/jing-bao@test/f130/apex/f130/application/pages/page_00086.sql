...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2242953195084343135)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2242961108223343345)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2242971947760343507)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2242961508369343345)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2242961108223343345)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2242963093393343347)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2242963454051343347)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2242963920849343347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242953593301343137)
,p_name=>'P86_WORK_SHIFT_CONFIG_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2242953195084343135)
,p_item_source_plug_id=>wwv_flow_imp.id(2242953195084343135)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242954024856343177)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242954427437343195)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242954688113343213)
,p_name=>'P86_REMARK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242955091779343232)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242955530026343250)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242955855496343268)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242956288642343286)
,p_name=>'P86_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242956567338343305)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242956977000343324)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2242957380920343342)
,p_name=>'P86_END_TIME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>110
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2237080618224020383)
...
,p_associated_item=>wwv_flow_imp.id(2242956977000343324)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2237080729278020384)
...
,p_validation_type=>'EXPRESSION'
,p_error_message=>unistr('\65F6\95F4\683C\5F0F\9519\8BEF')
,p_associated_item=>wwv_flow_imp.id(2242957380920343342)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2242961551835343345)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2242961508369343345)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2242962348655343346)
,p_event_id=>wwv_flow_imp.id(2242961551835343345)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2237080815785020385)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2237080843896020386)
,p_event_id=>wwv_flow_imp.id(2237080815785020385)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2237081012388020387)
,p_event_id=>wwv_flow_imp.id(2237080815785020385)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2151043909099019069)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2151043951447019070)
,p_event_id=>wwv_flow_imp.id(2151043909099019069)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2242964738862343348)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2242953195084343135)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2242965128919343348)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2242964278622343348)
,p_process_sequence=>10
