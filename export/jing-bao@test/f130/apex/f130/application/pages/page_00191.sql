...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2196470964054661169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2196471617100661168)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2196471994394661168)
,p_region_id=>wwv_flow_imp.id(2196471617100661168)
,p_chart_type=>'combo'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2196473733391661166)
,p_chart_id=>wwv_flow_imp.id(2196471994394661168)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2196269236727569772)
,p_chart_id=>wwv_flow_imp.id(2196471994394661168)
,p_seq=>20
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2196472548975661167)
,p_chart_id=>wwv_flow_imp.id(2196471994394661168)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2196269345167569773)
,p_chart_id=>wwv_flow_imp.id(2196471994394661168)
,p_axis=>'y2'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2196473158635661166)
,p_chart_id=>wwv_flow_imp.id(2196471994394661168)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2196268930731569769)
,p_name=>'P191_FAB'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2196268992646569770)
,p_name=>'P191_FC_CODE'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2196269068703569771)
,p_name=>'P191_SC_CODE'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
