...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2249121733618377761)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2250520318534212220)
,p_plug_name=>unistr('\65B0\5EFA')
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2250519443616212212)
,p_name=>'P60_FAB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2249121733618377761)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2250519547502212213)
,p_name=>'P60_DEP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2249121733618377761)
,p_prompt=>unistr('\65B0\5EFA')
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2250519669809212214)
,p_name=>'P60_PAIBAN'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2249121733618377761)
,p_prompt=>unistr('\65B0\5EFA')
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2166424736870395512)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166424926686395513)
,p_event_id=>wwv_flow_imp.id(2166424736870395512)
,p_event_result=>'TRUE'
