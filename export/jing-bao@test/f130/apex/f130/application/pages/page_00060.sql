...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2278002464710027310)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2279401049625861769)
,p_plug_name=>unistr('\65B0\5EFA')
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2279400174707861761)
,p_name=>'P60_FAB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2278002464710027310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2279400278593861762)
,p_name=>'P60_DEP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2278002464710027310)
,p_prompt=>unistr('\65B0\5EFA')
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2279400400900861763)
,p_name=>'P60_PAIBAN'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2278002464710027310)
,p_prompt=>unistr('\65B0\5EFA')
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195305467962045061)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195305657778045062)
,p_event_id=>wwv_flow_imp.id(2195305467962045061)
,p_event_result=>'TRUE'
