...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(895848350512329589)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(895848653408329592)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(895848350512329589)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(895848461392329591)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(895848407605329590)
,p_name=>'P278_CONTENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(895848350512329589)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(895850420533329610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(895850518040329611)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(895850633400329612)
,p_name=>'P278_COUNT'
,p_item_sequence=>100
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(895850890027329615)
,p_name=>'P278_CODE'
,p_item_sequence=>110
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(895848738675329593)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(895848653408329592)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895848853522329594)
,p_event_id=>wwv_flow_imp.id(895848738675329593)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(895848943066329595)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(895848461392329591)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895850251929329608)
,p_event_id=>wwv_flow_imp.id(895848943066329595)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895849333529329599)
,p_event_id=>wwv_flow_imp.id(895848943066329595)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895850764960329614)
,p_event_id=>wwv_flow_imp.id(895848943066329595)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895850669305329613)
,p_event_id=>wwv_flow_imp.id(895848943066329595)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(895849051377329596)
,p_event_id=>wwv_flow_imp.id(895848943066329595)
,p_event_result=>'TRUE'
