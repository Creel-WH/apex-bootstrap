...
wwv_flow_imp_page.create_page(
 p_id=>197
,p_name=>unistr('\4E8B\4EF6\590D\76D8')
,p_alias=>unistr('\4E8B\4EF6\590D\76D8')
,p_step_title=>unistr('\4E8B\4EF6\590D\76D8')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2152699819381162010)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2173270176565996430)
,p_name=>unistr('\590D\76D8\6570\636E\7EDF\8BA1')
,p_template=>wwv_flow_imp.id(2286693857423554758)
...
'       COUNT(CASE WHEN TRUNC(CREATION_DATE,''MM'') = TRUNC(SYSDATE,''MM'') THEN EVENT_ID END) MONTH_TOTAL,',
'       COUNT(CASE WHEN TRUNC(CREATION_DATE) = TRUNC(SYSDATE) THEN EVENT_ID END) DAY_TOTAL',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2173270261182996431)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2173270440501996432)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2173270543280996433)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2173271079035996439)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2173271159994996440)
,p_region_id=>wwv_flow_imp.id(2173271079035996439)
,p_chart_type=>'bar'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2173271556629996444)
,p_chart_id=>wwv_flow_imp.id(2173271159994996440)
,p_seq=>10
...
'           DESCRIPTION,SUBMIT_NAME,IS_STOP_LINE,IS_KEY_PROCESS,EVENT_DATE,EVENT_TIME,AUDIT_STATE,ACTIVE,STATUS,EXT_ORG_ID',
...
'               AND A.BEGIN_TIME >= TRUNC(SYSDATE - 70)',
'               AND A.BEGIN_TIME < TRUNC(SYSDATE) + 1) t',
...
'            WHERE IS_ENABLE = 1',
'              AND TENANT_ID = :USERTENANT AND BASE_DEPT_ID =:BASE_DEPT_ID AND DEL_FLAG=0)',
'SELECT (SELECT NAME FROM MPF_SHARE_DEPT_V S4 WHERE S4.EXT_ORG_ID = S3.EXT_ORG_ID AND S4.DEL_FLAG = 0 AND S4.TENANT_ID = :USERTENANT AND S4.BASE_DEPT_ID =:BASE_DEPT_ID) NAME,',
...
'               DESCRIPTION,SUBMIT_NAME,S1.IS_STOP_LINE,S1.IS_KEY_PROCESS,EVENT_DATE,S1.EVENT_TIME,AUDIT_STATE,ACTIVE,STATUS,S1.EXT_ORG_ID',
'          FROM S1,',
'               S2',
...
,p_group_name_column_name=>'AUDIT_STATE'
,p_group_short_desc_column_name=>'AUDIT_STATE'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2173271507060996443)
,p_chart_id=>wwv_flow_imp.id(2173271159994996440)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2173271431581996442)
,p_chart_id=>wwv_flow_imp.id(2173271159994996440)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2178309227482399747)
,p_branch_name=>unistr('\8F6C\5230\9875 239')
,p_branch_action=>'f?p=&APP_ID.:239:&SESSION.::&DEBUG.:239::&success_msg=#SUCCESS_MSG#'
