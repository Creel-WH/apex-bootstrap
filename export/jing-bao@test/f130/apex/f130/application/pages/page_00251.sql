...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2669349075159229980)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2669352935880229988)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2393745008430053232)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2669352935880229988)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2393745426687053232)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2393745834916053232)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393740021177053228)
,p_name=>'P251_CLASSIFY_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2669349075159229980)
,p_item_source_plug_id=>wwv_flow_imp.id(2669349075159229980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393740396339053229)
,p_name=>'P251_NAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393740831073053229)
,p_name=>'P251_REMARK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2669349075159229980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393741180184053229)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393741635405053229)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2393742023622053229)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2393746587211053240)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2393745008430053232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393747058697053240)
,p_event_id=>wwv_flow_imp.id(2393746587211053240)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2393747478588053240)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2393745426687053232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393748552052053241)
,p_event_id=>wwv_flow_imp.id(2393747478588053240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393748992348053241)
,p_event_id=>wwv_flow_imp.id(2393747478588053240)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393749471778053242)
,p_event_id=>wwv_flow_imp.id(2393747478588053240)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393748001418053241)
,p_event_id=>wwv_flow_imp.id(2393747478588053240)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2393749889637053242)
,p_name=>unistr('\65B0\5EFA')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2393745834916053232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393750411152053242)
,p_event_id=>wwv_flow_imp.id(2393749889637053242)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>unistr('\53C2\6570\6821\9A8C')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393750947776053243)
,p_event_id=>wwv_flow_imp.id(2393749889637053242)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393751454053053243)
,p_event_id=>wwv_flow_imp.id(2393749889637053242)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2393751933158053243)
,p_event_id=>wwv_flow_imp.id(2393749889637053242)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2393744326277053231)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2669349075159229980)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2393746218216053240)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2393743913683053231)
,p_process_sequence=>10
