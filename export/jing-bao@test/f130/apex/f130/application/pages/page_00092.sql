...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2338546618377975576)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2231980216366333460)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2338546618377975576)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2231980675880333460)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2201529545488578759)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2231996362904333467)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(628150829769777452)
,p_name=>'P92_CREATED_BY'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(2338546618377975576)
,p_item_source_plug_id=>wwv_flow_imp.id(2338546618377975576)
,p_source=>'CREATED_BY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(628150930487777453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(628151137959777455)
,p_name=>'P92_ORG_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2201529691148578760)
,p_name=>'P92_OLDID'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(2338546618377975576)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231981438142333461)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231981850756333461)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231982214336333461)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231982651402333461)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231983005377333462)
,p_name=>'P92_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231983478948333462)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231983833521333462)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231984208906333462)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231984671592333462)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231985008676333462)
,p_name=>'P92_END_TIME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231985444095333463)
,p_name=>'P92_REMARK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(2338546618377975576)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231985794431333463)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2231990512875333465)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231990999819333465)
,p_event_id=>wwv_flow_imp.id(2231990512875333465)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231991531442333465)
,p_event_id=>wwv_flow_imp.id(2231990512875333465)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2231991974073333465)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231992471833333466)
,p_event_id=>wwv_flow_imp.id(2231991974073333465)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2231992845484333466)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2231980675880333460)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231995845350333467)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231993366386333466)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231993836821333466)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231994326349333466)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231994797351333467)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231995354154333467)
,p_event_id=>wwv_flow_imp.id(2231992845484333466)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2201529727358578761)
,p_name=>unistr('\65B0\5EFA_1')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2201529545488578759)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2201529816954578762)
,p_event_id=>wwv_flow_imp.id(2201529727358578761)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2201529985753578763)
,p_event_id=>wwv_flow_imp.id(2201529727358578761)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2231989370674333464)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2338546618377975576)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2231988911370333464)
,p_process_sequence=>10
