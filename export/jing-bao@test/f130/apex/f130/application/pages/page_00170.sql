...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2207031255461206497)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2207042036348206510)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2200567717016067484)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2207042036348206510)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2200568083410067484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200551841018993984)
,p_name=>'P170_IS_WORK_STATION_ENABLE'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2207031255461206497)
,p_item_source_plug_id=>wwv_flow_imp.id(2207031255461206497)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200551914002993985)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200551988428993986)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200553048001993996)
,p_name=>'P170_FLAG'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(2207031255461206497)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200561294763067478)
,p_name=>'P170_FAB_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200561684080067479)
,p_name=>'P170_BASE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2207031255461206497)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200562791017067480)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200563249851067480)
,p_name=>'P170_REMARK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200563623954067480)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2200564021244067481)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2200568881552067495)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2200567717016067484)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2200569363333067496)
,p_event_id=>wwv_flow_imp.id(2200568881552067495)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2200569825304067496)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2200568083410067484)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2200570348244067497)
,p_event_id=>wwv_flow_imp.id(2200569825304067496)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2200570806032067497)
,p_event_id=>wwv_flow_imp.id(2200569825304067496)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2200571327181067497)
,p_event_id=>wwv_flow_imp.id(2200569825304067496)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2200571764673067498)
,p_event_id=>wwv_flow_imp.id(2200569825304067496)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2200567037976067483)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2207031255461206497)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2200568480575067494)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2200566606549067483)
,p_process_sequence=>10
