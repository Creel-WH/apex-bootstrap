...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2197666790584404989)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2197667215913404989)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2197666790584404989)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2197669022251404991)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2197669435306404991)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(639197635607210616)
,p_name=>'P164_CONVERSATION_ID_1'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(2197657273182404980)
,p_item_source_plug_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197307993335277902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197308075288277903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197657688940404982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197658104671404984)
,p_name=>'P164_REMARK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197658478109404984)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197658896392404985)
,p_name=>'P164_DEPT_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197659292749404985)
,p_name=>'P164_FAB_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197659751887404985)
,p_name=>'P164_TYPES'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197660120853404985)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2197660948257404986)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2202231726883727390)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2197667338312404989)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2197667215913404989)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197668087045404990)
,p_event_id=>wwv_flow_imp.id(2197667338312404989)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2197308255361277904)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2197669022251404991)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197308305002277905)
,p_event_id=>wwv_flow_imp.id(2197308255361277904)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197308474632277907)
,p_event_id=>wwv_flow_imp.id(2197308255361277904)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197308643356277908)
,p_event_id=>wwv_flow_imp.id(2197308255361277904)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197308714899277909)
,p_event_id=>wwv_flow_imp.id(2197308255361277904)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2197308814675277910)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2197669435306404991)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197695309496716961)
,p_event_id=>wwv_flow_imp.id(2197308814675277910)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197695452475716962)
,p_event_id=>wwv_flow_imp.id(2197308814675277910)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197695505882716963)
,p_event_id=>wwv_flow_imp.id(2197308814675277910)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197695609744716964)
,p_event_id=>wwv_flow_imp.id(2197308814675277910)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2197670245376404992)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2197657273182404980)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2197670655262404992)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2197669823661404992)
,p_process_sequence=>10
