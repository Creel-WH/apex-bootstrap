...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2270622623041522039)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2270622843347522041)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2214393869087214250)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2270622843347522041)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2214394344941214252)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2214391987552214246)
,p_name=>'P225_CONTEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2270622623041522039)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2214392417994214248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2214392771514214248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2214393242113214248)
,p_name=>'P225_FLAG'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2270622623041522039)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2214394657854214263)
,p_name=>unistr('\4E0D\901A\8FC7')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2214393869087214250)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214395157304214265)
,p_event_id=>wwv_flow_imp.id(2214394657854214263)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214395663675214265)
,p_event_id=>wwv_flow_imp.id(2214394657854214263)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214396213261214265)
,p_event_id=>wwv_flow_imp.id(2214394657854214263)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214396725114214265)
,p_event_id=>wwv_flow_imp.id(2214394657854214263)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2214397107646214266)
,p_name=>unistr('\901A\8FC7')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2214394344941214252)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214397644915214266)
,p_event_id=>wwv_flow_imp.id(2214397107646214266)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214398091328214266)
,p_event_id=>wwv_flow_imp.id(2214397107646214266)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214398596747214266)
,p_event_id=>wwv_flow_imp.id(2214397107646214266)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2214399130622214266)
,p_event_id=>wwv_flow_imp.id(2214397107646214266)
,p_event_result=>'TRUE'
