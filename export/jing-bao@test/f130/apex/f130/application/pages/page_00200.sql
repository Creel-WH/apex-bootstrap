...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2239555843430391770)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2239556063736391772)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2225851210462705001)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2239556063736391772)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2225851653561705000)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2199892759560110450)
,p_name=>'P200_FLAG'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2239555843430391770)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2225849727364705004)
,p_name=>'P200_CONTEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2239555843430391770)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2225850108827705003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2225850582184705002)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2225852087990704994)
,p_name=>unistr('\4E0D\901A\8FC7')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2225851210462705001)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225852572908704993)
,p_event_id=>wwv_flow_imp.id(2225852087990704994)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225853013583704993)
,p_event_id=>wwv_flow_imp.id(2225852087990704994)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225853522479704992)
,p_event_id=>wwv_flow_imp.id(2225852087990704994)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225854002676704992)
,p_event_id=>wwv_flow_imp.id(2225852087990704994)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2225854413032704992)
,p_name=>unistr('\901A\8FC7')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2225851653561705000)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225854896023704992)
,p_event_id=>wwv_flow_imp.id(2225854413032704992)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225855411742704992)
,p_event_id=>wwv_flow_imp.id(2225854413032704992)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225855986978704992)
,p_event_id=>wwv_flow_imp.id(2225854413032704992)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2225856395582704991)
,p_event_id=>wwv_flow_imp.id(2225854413032704992)
,p_event_result=>'TRUE'
