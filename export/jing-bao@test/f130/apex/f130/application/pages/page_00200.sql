...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2166433294953811227)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2166433515259811229)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2152728661986124458)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2166433515259811229)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2152729105085124457)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2126770211083529907)
,p_name=>'P200_FLAG'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2166433294953811227)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2152727178888124461)
,p_name=>'P200_CONTEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2166433294953811227)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2152727560351124460)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2152728033708124459)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2152729539514124451)
,p_name=>unistr('\4E0D\901A\8FC7')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2152728661986124458)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152730024432124450)
,p_event_id=>wwv_flow_imp.id(2152729539514124451)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152730465107124450)
,p_event_id=>wwv_flow_imp.id(2152729539514124451)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152730974003124449)
,p_event_id=>wwv_flow_imp.id(2152729539514124451)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152731454200124449)
,p_event_id=>wwv_flow_imp.id(2152729539514124451)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2152731864556124449)
,p_name=>unistr('\901A\8FC7')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2152729105085124457)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152732347547124449)
,p_event_id=>wwv_flow_imp.id(2152731864556124449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152732863266124449)
,p_event_id=>wwv_flow_imp.id(2152731864556124449)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152733438502124449)
,p_event_id=>wwv_flow_imp.id(2152731864556124449)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2152733847106124448)
,p_event_id=>wwv_flow_imp.id(2152731864556124449)
,p_event_result=>'TRUE'
