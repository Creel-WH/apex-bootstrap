...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2195607767842004097)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2195608434118004103)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(2195607767842004097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195607909326004098)
,p_name=>'P107_EVENTID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2195607767842004097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195608016240004099)
,p_name=>'P107_LABELID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2195607767842004097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195608086048004100)
,p_name=>'P107_REMARK'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2195607767842004097)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195608568203004105)
,p_name=>unistr('\65B0\5EFA')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2195608434118004103)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195608663141004106)
,p_event_id=>wwv_flow_imp.id(2195608568203004105)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195903134125607561)
,p_event_id=>wwv_flow_imp.id(2195608568203004105)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2196060818006614987)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2196060906290614988)
,p_event_id=>wwv_flow_imp.id(2196060818006614987)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2197460657787785796)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2197460701435785797)
,p_event_id=>wwv_flow_imp.id(2197460657787785796)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2195608277310004102)
