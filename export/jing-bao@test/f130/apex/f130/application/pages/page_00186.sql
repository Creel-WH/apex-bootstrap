...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2195102885309150172)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2195103332468150171)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2195103687682150171)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195104069088150168)
,p_name=>'P186_MOBILE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195104480704150167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195104925031150167)
,p_name=>'P186_CODE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195105289334150167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195105726821150166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195106143893150166)
,p_name=>'P186_FLAG'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2195106550189150166)
,p_name=>'P186_USER_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(2200811520443392740)
,p_item_source_plug_id=>wwv_flow_imp.id(2200811520443392740)
,p_source=>'USER_ID'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2195108512030150160)
...
,p_associated_item=>wwv_flow_imp.id(2195105726821150166)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195109184837150159)
,p_name=>unistr('\53D1\9001\9A8C\8BC1\7801')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2195102885309150172)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195109697999150158)
,p_event_id=>wwv_flow_imp.id(2195109184837150159)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195110203745150158)
,p_event_id=>wwv_flow_imp.id(2195109184837150159)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195110717700150158)
,p_event_id=>wwv_flow_imp.id(2195109184837150159)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195111213342150157)
,p_event_id=>wwv_flow_imp.id(2195109184837150159)
,p_event_result=>'TRUE'
...
,p_affected_button_id=>wwv_flow_imp.id(2195102885309150172)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195111573026150157)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195112074319150157)
,p_event_id=>wwv_flow_imp.id(2195111573026150157)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195112507574150157)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2195103332468150171)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195112966390150157)
,p_event_id=>wwv_flow_imp.id(2195112507574150157)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2195113439944150157)
,p_name=>unistr('\4FDD\5B58')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2195103687682150171)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195113862720150156)
,p_event_id=>wwv_flow_imp.id(2195113439944150157)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195114361321150156)
,p_event_id=>wwv_flow_imp.id(2195113439944150157)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195114870851150156)
,p_event_id=>wwv_flow_imp.id(2195113439944150157)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2195115378233150156)
,p_event_id=>wwv_flow_imp.id(2195113439944150157)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2195107643053150163)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2200811520443392740)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2195108759720150159)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2195107229143150164)
,p_process_sequence=>10
