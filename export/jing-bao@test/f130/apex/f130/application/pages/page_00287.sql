...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(633245517336886719)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(633245875280886719)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(633246289971886718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870301862980905565)
,p_name=>'P287_RULE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302003627905566)
...
,p_lov=>'.'||wwv_flow_imp.id(244983161548467630)||'.'
,p_cSize=>30
,p_grid_column=>2
,p_field_template=>wwv_flow_imp.id(2359868244347135324)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302235038905568)
,p_name=>'P287_TIME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302322219905569)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302506880905571)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302566447905572)
,p_name=>'P287_TIME_2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302684835905573)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870302750339905574)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(870303717426905583)
,p_name=>'P287_COUNT'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(870300068776905566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(873723937737952876)
,p_name=>'P287_RULE_ID'
,p_item_sequence=>80
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633249934382886716)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(633245517336886719)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633250373514886716)
,p_event_id=>wwv_flow_imp.id(633249934382886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633250829085886716)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(633246289971886718)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633251280167886715)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633251837638886715)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633252354664886715)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633252805209886714)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633253367621886714)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633253843372886714)
,p_event_id=>wwv_flow_imp.id(633250829085886716)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633254179348886714)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(633245875280886719)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633254707342886714)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633255265643886713)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633255735852886713)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633256196529886713)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633256753543886713)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633257188883886712)
,p_event_id=>wwv_flow_imp.id(633254179348886714)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633257657326886712)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633258112675886712)
,p_event_id=>wwv_flow_imp.id(633257657326886712)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633258577262886712)
,p_event_id=>wwv_flow_imp.id(633257657326886712)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(633259015362886712)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633259484627886712)
,p_event_id=>wwv_flow_imp.id(633259015362886712)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(633259980786886711)
,p_event_id=>wwv_flow_imp.id(633259015362886712)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
