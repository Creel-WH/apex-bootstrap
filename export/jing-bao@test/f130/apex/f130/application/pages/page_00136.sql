...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2231777053606388246)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2231777664947388252)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_imp.id(2231777053606388246)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2231777725837388253)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231777099267388247)
,p_name=>'P136_CONVERSATION_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2231777053606388246)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231777220699388248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231777321491388249)
,p_name=>'P136_ENABLE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(2231777053606388246)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231777428217388250)
,p_name=>'P136_DEPID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2231777053606388246)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2231777589390388251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2232572296414530651)
,p_name=>'P136_FABID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2231777053606388246)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2232572473386530652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2232572577746530653)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2234037223606895149)
,p_name=>'P136_TYPES'
,p_is_required=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(2231777053606388246)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2243098290144526637)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2243098536632526639)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2231777869809388254)
,p_name=>unistr('\65B0\5EFA')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2231777664947388252)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231777909198388255)
,p_event_id=>wwv_flow_imp.id(2231777869809388254)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2231778089432388256)
,p_name=>unistr('\65B0\5EFA_1')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2231777725837388253)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231778148592388257)
,p_event_id=>wwv_flow_imp.id(2231778089432388256)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2243098459092526638)
,p_event_id=>wwv_flow_imp.id(2231778089432388256)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2243098646914526640)
,p_event_id=>wwv_flow_imp.id(2231778089432388256)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2231778198721388258)
,p_event_id=>wwv_flow_imp.id(2231778089432388256)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2234504744959231218)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2234504802828231219)
,p_event_id=>wwv_flow_imp.id(2234504744959231218)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2231778372535388259)
