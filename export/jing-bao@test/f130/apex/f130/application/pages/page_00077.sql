...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2229977127662863031)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2311298773594885338)
,p_plug_name=>unistr('\65B0\5EFA')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2311592772859068019)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2311593168365068019)
,p_region_id=>wwv_flow_imp.id(2311592772859068019)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2311593659017068020)
,p_chart_id=>wwv_flow_imp.id(2311593168365068019)
,p_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2311299030465885341)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(2311298773594885338)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2311298844178885339)
,p_name=>'P77_BEGIN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2311298773594885338)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2311298966746885340)
,p_name=>'P77_END'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2311298773594885338)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2224168205070599630)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2224168343077599631)
,p_event_id=>wwv_flow_imp.id(2224168205070599630)
,p_event_result=>'TRUE'
