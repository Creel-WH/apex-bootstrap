prompt --application/pages/page_01124
begin
--   Manifest
--     PAGE: 01124
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>1124
,p_name=>unistr('\5BFC\822A Menu - Mega Menu Preview 2')
,p_alias=>'NAVIGATION-MENU-MEGA-MENU-PREVIEW-2'
,p_step_title=>unistr('\5BFC\822A Menu - Mega Menu Preview 2')
...
,p_navigation_list_id=>wwv_flow_imp.id(2272677234216391368)
,p_navigation_list_template_id=>wwv_flow_imp.id(1648532356850703387)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5840596761308977990)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5840598724537978010)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5840598838241978011)
,p_plug_name=>unistr('\533A\57DF B')
,p_region_css_classes=>'dm-Placeholder h180'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5840742365144478889)
