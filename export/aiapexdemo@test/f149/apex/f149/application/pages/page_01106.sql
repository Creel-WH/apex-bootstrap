...
wwv_flow_imp_page.create_page(
 p_id=>1106
,p_name=>unistr('Right Column Page with \9876\90E8\5BFC\822A')
,p_alias=>'RIGHT-COLUMN-PAGE-WITH-TOP-NAVIGATION'
,p_step_title=>unistr('Right Column Page with \9876\90E8\5BFC\822A - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321529453471720799)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321529853382720801)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321531038259720802)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328455932934634219)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328455992605634220)
