...
wwv_flow_imp_page.create_page(
 p_id=>1401
,p_name=>unistr('Reports - \6807\51C6')
,p_alias=>'STANDARD-REPORTS'
,p_step_title=>unistr('\6807\51C6 Reports - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1217699576771453911)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846455619139370028)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_grid_column_span=>8
,p_plug_source=>'<p>This is the default report template used for displaying tabular data.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846456058551370029)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846456626153370029)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846472575684412967)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1846473130901412968)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1846473533009412970)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1846473916083412972)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1846474264327412972)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1846474716246412973)
,p_query_column_id=>4
