...
wwv_flow_imp_page.create_page(
 p_id=>1105
,p_name=>unistr('Right Column Page with Side \5BFC\822A')
,p_alias=>'RIGHT-COLUMN-PAGE-WITH-SIDE-NAVIGATION'
,p_step_title=>unistr('Right Column Page with Side \5BFC\822A - &APP_TITLE.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_javascript_code_onload=>'apex.theme42demo.noNavigate();'
,p_step_template=>wwv_flow_imp.id(2508285339576992887)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315771262408599166)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321525532841709191)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321525887780709192)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321527083476709194)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328455715097634217)
,p_plug_name=>unistr('\533A\57DF B')
,p_region_css_classes=>'dm-Placeholder'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
