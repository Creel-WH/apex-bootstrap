prompt --application/pages/page_01303
begin
--   Manifest
--     PAGE: 01303
--   Manifest End
...
,p_name=>'Lists - Links'
,p_alias=>'LINKS-LIST'
,p_step_title=>unistr('\94FE\63A5\5217\8868 - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1230948997333448406)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1230949069161448407)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846389631842023896)
...
,p_plug_grid_column_span=>8
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_plug_source=>'<p>This list template provides a list of links which can be used for navigation and other action-oriented tasks. You can optionally show badges, icons, sub list items, and more.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846390080578023896)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846390599722023897)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1846400479079034612)
...
'select ''#A01#'', ''The badge'' from dual union all',
'select ''#A02#'', ''HTML Attributes for the link inside of the Links List item.'' from dual union all',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1230949141432448408)
,p_query_column_id=>1
,p_column_alias=>'''#A01#'''
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1230949305527448409)
,p_query_column_id=>2
,p_column_alias=>'''THEBADGE'''
,p_column_display_sequence=>20
,p_column_heading=>'&#x27;thebadge&#x27;'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1846402506086034614)
...
,p_plug_grid_column_span=>8
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_list_id=>wwv_flow_imp.id(3336263356069235513)
