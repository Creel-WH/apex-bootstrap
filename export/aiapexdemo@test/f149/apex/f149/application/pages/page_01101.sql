...
wwv_flow_imp_page.create_page(
 p_id=>1101
,p_name=>unistr('\6807\51C6\9875\9762\6A21\677F with Side \5BFC\822A')
,p_alias=>'STANDARD-PAGE-TEMPLATE-WITH-SIDE-NAVIGATION'
,p_step_title=>unistr('\6807\51C6\9875\9762\6A21\677F with Side \5BFC\822A - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3204643087562528704)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3204643559750528740)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768550140599139)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768717176599140)
