...
wwv_flow_imp_page.create_page(
 p_id=>1905
,p_name=>unistr('\9759\6001\5185\5BB9')
,p_alias=>'STATIC-CONTENT'
,p_step_title=>unistr('\9759\6001\5185\5BB9 - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1231997380094109576)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1231997538901109577)
,p_plug_name=>unistr('\9759\6001\5185\5BB9')
,p_region_name=>'Demo1'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5877108208603591313)
...
,p_plug_grid_column_span=>8
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_plug_source=>'<p>The <strong>Static Content</strong> Region Type is a very basic region component which can be used for many purposes.  It is one of the most versatile components available for controlling the layout of your page, or for organizing regions and form'
||' items.  It can also be used to render HTML directly within your APEX application.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5877108524789589621)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8359901235632018453)
