...
wwv_flow_imp_page.create_page(
 p_id=>1104
,p_name=>unistr('Left Column Page with \9876\90E8\5BFC\822A')
,p_alias=>'LEFT-COLUMN-PAGE-WITH-TOP-NAVIGATION'
,p_step_title=>unistr('Left Column Page with \9876\90E8\5BFC\822A - &APP_TITLE.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_javascript_code_onload=>'apex.theme42demo.noNavigate();'
,p_step_template=>wwv_flow_imp.id(2508281793896950010)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315771116750599164)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315771227144599165)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315932717749275414)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315933458446275418)
,p_plug_name=>unistr('\4FA7\8FB9\533A\57DF')
,p_region_css_classes=>'dm-Placeholder'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315934278798275419)
