...
wwv_flow_imp_page.create_page(
 p_id=>1113
,p_name=>unistr('\7B80\6D01\9875\9762\6A21\677F')
,p_alias=>'MINIMAL-PAGE-TEMPLATE'
,p_step_title=>unistr('\7B80\6D01\9875\9762\6A21\677F - &APP_TITLE.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(2960713786869550737)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3329903333583668927)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3329903728791668931)
,p_plug_name=>unistr('\533A\57DF B')
,p_region_css_classes=>'dm-Placeholder h180'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3329904491657668931)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3329905172499668949)
