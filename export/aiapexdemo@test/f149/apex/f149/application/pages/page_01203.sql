...
wwv_flow_imp_page.create_page(
 p_id=>1203
,p_name=>unistr('Region - \4E3B\89C6\89C9\533A')
,p_alias=>'HERO-REGION'
,p_step_title=>unistr('\4E3B\89C6\89C9\533A Region - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1230948783832448404)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835719730581551924)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835073582826037545)
,p_plug_name=>unistr('\4E3B\89C6\89C9\533A Region With \6309\94AE')
,p_parent_plug_id=>wwv_flow_imp.id(1835719730581551924)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835723228502551928)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_grid_column_span=>8
,p_plug_source=>'<p>Capture your users'' attention on homepage, dashboard, and other introductory-style pages. This region template displays an icon, heading and sub headings, and buttons.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835723653789551929)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835724218762551929)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835724696100551929)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1230948896539448405)
,p_plug_name=>unistr('\4E3B\89C6\89C9\533A')
,p_region_name=>'Demo1'
,p_parent_plug_id=>wwv_flow_imp.id(1835724696100551929)
,p_icon_css_classes=>'fa-map-pin-heart'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(2655656254774638580)
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>'<p>This is a Hero region</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1835746145675683730)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1835721299264551926)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1835073582826037545)
,p_button_name=>unistr('\6309\94AE')
