prompt --application/pages/page_01908
begin
--   Manifest
--     PAGE: 01908
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>1908
,p_name=>unistr('\52A8\6001\5185\5BB9')
,p_alias=>'DYNAMIC-CONTENT'
,p_step_title=>unistr('\52A8\6001\5185\5BB9 - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1066662750508617422)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1066662931237617423)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1066663087541617425)
,p_plug_name=>unistr('\6F14\793A')
,p_region_name=>'Demo1'
,p_parent_plug_id=>wwv_flow_imp.id(1066662931237617423)
...
'  l_clob := l_clob || ''<ul>'';',
'',
'  for c1 in ( select task_name, assigned_to',
'                from eba_ut_chart_tasks',
'               where rownum < 5 )',
'  loop',
'        l_clob := l_clob || ''<li>'' || apex_escape.html(c1.task_name) || '' ('' || apex_escape.html(c1.assigned_to) || '')</li>'';',
'  end loop;',
'',
'  l_clob := l_clob || ''</ul>'';',
'',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1066663040902617424)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7892335236793066596)
...
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p><strong>Dynamic Content</strong> region is based on Render dynamic content using PL/SQL Function Body returning a CLOB. With Dynamic Content Region you can control the region performance and contains support for MLE.</p>',
'<p class="dm-Hero-steps">Set <strong>Dynamic Content</strong> as the Region type.</p>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7892335312751064079)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11003387586480748579)
