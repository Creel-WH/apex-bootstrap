prompt --application/pages/page_01901
begin
--   Manifest
--     PAGE: 01901
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>1901
,p_name=>unistr('\6811\5F62')
,p_alias=>'TREE'
,p_step_title=>unistr('\6811\5F62 - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1231998086285109583)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1231998314126109585)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3133114285810197750)
,p_plug_name=>unistr('\6F14\793A')
,p_region_name=>'Demo1'
,p_parent_plug_id=>wwv_flow_imp.id(1231998314126109585)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'node_status_column', unistr('\72B6\6001'),
  'node_value_column', 'VALUE',
  'tree_hierarchy', 'LEVEL',
  'tree_tooltip', 'N')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3133114194877197749)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5716503186302499942)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5877102665017480617)
...
,p_plug_grid_column_span=>8
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_plug_source=>'<p><strong>Tree</strong> is a hierarchical navigational control based on a SQL query executed at runtime.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5877103958044488046)
