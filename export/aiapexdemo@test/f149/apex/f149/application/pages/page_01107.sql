...
wwv_flow_imp_page.create_page(
 p_id=>1107
,p_name=>unistr('Marquee Detail Page with Side \5BFC\822A')
,p_alias=>'MARQUEE-DETAIL-PAGE-WITH-SIDE-NAVIGATION'
,p_step_title=>unistr('Marquee Detail Page with Side \5BFC\822A - &APP_TITLE.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_javascript_code_onload=>'apex.theme42demo.noNavigate();'
,p_step_template=>wwv_flow_imp.id(1979999869797913631)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768222588599135)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768254577599136)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768424178599137)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768457613599138)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321533970843759587)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321534388786759589)
,p_plug_name=>unistr('\4FA7\8FB9\5185\5BB9')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3321535610653759591)
