prompt --application/pages/page_01122
begin
--   Manifest
--     PAGE: 01122
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>1122
,p_name=>unistr('\5BFC\822A Menu - Mega Menu Preview')
,p_alias=>'NAVIGATION-MENU-MEGA-MENU-PREVIEW'
,p_step_title=>unistr('\5BFC\822A Menu - Mega Menu Preview')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4998590776671148141)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4998592739900148161)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4998592853604148162)
,p_plug_name=>unistr('\533A\57DF B')
,p_region_css_classes=>'dm-Placeholder h180'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4998736380506649040)
