...
wwv_flow_imp_page.create_page(
 p_id=>1120
,p_name=>unistr('\5BFC\822A Menu - \83DC\5355\680F Preview')
,p_alias=>'NAVIGATION-MENU-BAR-PREVIEW'
,p_step_title=>unistr('\5BFC\822A Menu - \83DC\5355\680F Preview')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4156591854224346277)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4156593817453346297)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4156593931157346298)
,p_plug_name=>unistr('\533A\57DF B')
,p_region_css_classes=>'dm-Placeholder h180'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4156737458059847176)
