...
wwv_flow_imp_page.create_page(
 p_id=>1110
,p_name=>unistr('Side Columns Page with \9876\90E8\5BFC\822A')
,p_alias=>'SIDE-COLUMNS-PAGE-WITH-TOP-NAVIGATION'
,p_step_title=>unistr('Side Columns Page with \9876\90E8\5BFC\822A - &APP_TITLE.')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_javascript_code_onload=>'apex.theme42demo.noNavigate();'
,p_step_template=>wwv_flow_imp.id(2508288915898998367)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328397867885569286)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328398247015569287)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328399039764569288)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328399497350569288)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328399914920569288)
,p_plug_name=>unistr('\4FA7\8FB9\5185\5BB9')
,p_region_css_classes=>'dm-Placeholder'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328400651836569290)
