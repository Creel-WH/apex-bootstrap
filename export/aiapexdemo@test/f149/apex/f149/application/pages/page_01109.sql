...
wwv_flow_imp_page.create_page(
 p_id=>1109
,p_name=>unistr('Side Columns Page with Side \5BFC\822A')
,p_alias=>'SIDE-COLUMNS-PAGE-WITH-SIDE-NAVIGATION'
,p_step_title=>unistr('Side Columns Page with Side \5BFC\822A - &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315770539105599159)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315770676587599160)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315770744556599161)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328385750390547693)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328386142436547697)
,p_plug_name=>unistr('\4FA7\8FB9\5185\5BB9')
,p_region_css_classes=>'dm-Placeholder'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3328387350485547699)
