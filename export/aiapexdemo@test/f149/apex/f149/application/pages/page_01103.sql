...
wwv_flow_imp_page.create_page(
 p_id=>1103
,p_name=>unistr('Left Column Page with Side \5BFC\822A ')
,p_alias=>'LEFT-COLUMN-PAGE-WITH-SIDE-NAVIGATION'
,p_step_title=>unistr('Left Column Page with Side \5BFC\822A- &APP_TITLE.')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315768115352599134)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315770872894599162)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315770949198599163)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315924863969173883)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3315926103222173890)
