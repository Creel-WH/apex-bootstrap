...
wwv_flow_imp_page.create_page(
 p_id=>1210
,p_name=>unistr('Region \56FE\7247')
,p_alias=>'REGION-IMAGE'
,p_step_title=>unistr('Region \56FE\7247')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1763817497855153544)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1763817649879153545)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2367741410215999267)
...
,p_plug_grid_column_span=>8
,p_plug_grid_column_css_classes=>'col-sm-12'
,p_plug_source=>'<p>Display a single image within a region. The Image region template only supports images and will not display text.</p>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2367741981935999267)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2367742399930999268)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2367742908649999269)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2367749333169007835)
,p_plug_name=>unistr('Region \56FE\7247')
,p_region_name=>'Demo1'
,p_parent_plug_id=>wwv_flow_imp.id(2367742908649999269)
,p_region_template_options=>'#DEFAULT#:t-ImageRegion--noFilter:t-ImageRegion--auto:t-ImageRegion--cover:t-ImageRegion--square'
,p_plug_template=>wwv_flow_imp.id(1174267882824893558)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
,p_region_image=>'#APP_FILES#img/diversity.jpg'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
