...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(2082046026875428236)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364375787205707531)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364375892702707531)
,p_page_template_id=>wwv_flow_imp.id(2082046026875428236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364375975077707531)
,p_page_template_id=>wwv_flow_imp.id(2082046026875428236)
