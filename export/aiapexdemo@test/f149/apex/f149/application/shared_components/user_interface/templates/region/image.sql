...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1174267882824893558)
,p_layout=>'TABLE'
...
,p_page_plug_template_name=>unistr('\56FE\7247')
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364384320815707564)
,p_plug_template_id=>wwv_flow_imp.id(1174267882824893558)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364384413032707564)
,p_plug_template_id=>wwv_flow_imp.id(1174267882824893558)
