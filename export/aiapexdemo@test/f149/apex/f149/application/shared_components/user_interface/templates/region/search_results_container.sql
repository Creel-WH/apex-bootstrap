...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1052878553902820512)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364388145014707571)
,p_plug_template_id=>wwv_flow_imp.id(1052878553902820512)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364388319457707571)
,p_plug_template_id=>wwv_flow_imp.id(1052878553902820512)
,p_name=>unistr('\641C\7D22 Field')
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364388387257707571)
,p_plug_template_id=>wwv_flow_imp.id(1052878553902820512)
