...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4483079085784721863)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379046525707544)
,p_plug_template_id=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379176308707544)
,p_plug_template_id=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379288599707544)
,p_plug_template_id=>wwv_flow_imp.id(4483079085784721863)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379346963707544)
,p_plug_template_id=>wwv_flow_imp.id(4483079085784721863)
