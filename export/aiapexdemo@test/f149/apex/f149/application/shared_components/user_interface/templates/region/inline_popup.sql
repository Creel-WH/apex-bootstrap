...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1467007762335726542)
,p_layout=>'TABLE'
...
'</div>',
'</div>'))
,p_page_plug_template_name=>unistr('\5185\8054\5F39\7A97')
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386086423707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386232184707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386306121707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386420872707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386521711707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386640352707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386735099707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364386753555707568)
,p_plug_template_id=>wwv_flow_imp.id(1467007762335726542)
