...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2655796417887417688)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364387713120707571)
,p_plug_template_id=>wwv_flow_imp.id(2655796417887417688)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364387789598707571)
,p_plug_template_id=>wwv_flow_imp.id(2655796417887417688)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364387850138707571)
,p_plug_template_id=>wwv_flow_imp.id(2655796417887417688)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364388019893707571)
,p_plug_template_id=>wwv_flow_imp.id(2655796417887417688)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364388063973707571)
,p_plug_template_id=>wwv_flow_imp.id(2655796417887417688)
