...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2054362936031481055)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364380796889707548)
,p_plug_template_id=>wwv_flow_imp.id(2054362936031481055)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364380939025707548)
,p_plug_template_id=>wwv_flow_imp.id(2054362936031481055)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364380959429707548)
,p_plug_template_id=>wwv_flow_imp.id(2054362936031481055)
