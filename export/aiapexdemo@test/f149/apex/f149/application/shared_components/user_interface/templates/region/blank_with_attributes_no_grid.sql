...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3352876222347251435)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379515838707545)
,p_plug_template_id=>wwv_flow_imp.id(3352876222347251435)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379559923707545)
,p_plug_template_id=>wwv_flow_imp.id(3352876222347251435)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379729207707545)
,p_plug_template_id=>wwv_flow_imp.id(3352876222347251435)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1364379820320707545)
,p_plug_template_id=>wwv_flow_imp.id(3352876222347251435)
