...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10217401091010882214)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10217401885531882222)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3743245512165882968)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10217401885531882222)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3743245929013882968)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10217402102331882219)
,p_name=>'P225_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(10217401091010882214)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10217402220394882220)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10217402383168882222)
,p_name=>'P225_ROLE'
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(10217401091010882214)
,p_item_source_plug_id=>wwv_flow_imp.id(10217401091010882214)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3743246554963882969)
,p_name=>unistr('\5207\6362\89D2\8272')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3743245929013882968)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3743247065000882969)
,p_event_id=>wwv_flow_imp.id(3743246554963882969)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3743247531632882969)
,p_event_id=>wwv_flow_imp.id(3743246554963882969)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3743248001519882970)
,p_event_id=>wwv_flow_imp.id(3743246554963882969)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(568006719910369748)
,p_event_id=>wwv_flow_imp.id(3743246554963882969)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3743248428451882970)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3743245512165882968)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3743248929943882970)
,p_event_id=>wwv_flow_imp.id(3743248428451882970)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3743244888631882968)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(10217401091010882214)
