...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3305291130319899963)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3305291406507899965)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3305291488749899966)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3305291406507899965)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3305291703696899968)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3305291266760899964)
,p_name=>'P140_PLANS_FILE_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3305291130319899963)
...
,p_lov=>'.'||wwv_flow_imp.id(3309104417032482545)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3307641688228814328)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3307641764186814329)
,p_name=>'P140_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3305292014249899971)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3305291703696899968)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3305292114046899972)
,p_event_id=>wwv_flow_imp.id(3305292014249899971)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3305292350294899975)
,p_event_id=>wwv_flow_imp.id(3305292014249899971)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3307641522700814326)
,p_event_id=>wwv_flow_imp.id(3305292014249899971)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3307641837641814330)
,p_event_id=>wwv_flow_imp.id(3305292014249899971)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3307641969519814331)
,p_event_id=>wwv_flow_imp.id(3305292014249899971)
,p_event_result=>'TRUE'
