...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3520551137426373307)
,p_plug_name=>unistr('\6587\4EF6\4E0A\4F20')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(9726563009965841976)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3520551311686373308)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3274507676838374270)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3520551311686373308)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3274507267216374270)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3520551311686373308)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274520704822481173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274520910409481175)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3520551934126373318)
,p_name=>'P136_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3520551137426373307)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3737537803773437271)
,p_name=>'P136_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3737537868505437272)
,p_name=>'P136_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3737537962187437273)
,p_name=>'P136_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>140
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3737538147612437274)
,p_name=>'P136_COUNT'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3737538451077437278)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3739360804135626907)
,p_name=>'P136_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274510361281374276)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3274507267216374270)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274510841379374276)
,p_event_id=>wwv_flow_imp.id(3274510361281374276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274511240576374276)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3274507676838374270)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274511700658374276)
,p_event_id=>wwv_flow_imp.id(3274511240576374276)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274513252581374280)
,p_event_id=>wwv_flow_imp.id(3274511240576374276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274513766989374281)
,p_event_id=>wwv_flow_imp.id(3274511240576374276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274512766563374277)
,p_event_id=>wwv_flow_imp.id(3274511240576374276)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274514094608374281)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274515079100374281)
,p_event_id=>wwv_flow_imp.id(3274514094608374281)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3274507676838374270)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274514615081374281)
,p_event_id=>wwv_flow_imp.id(3274514094608374281)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274515487866374281)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274515991130374281)
,p_event_id=>wwv_flow_imp.id(3274515487866374281)
,p_event_result=>'TRUE'
,p_action_sequence=>10
