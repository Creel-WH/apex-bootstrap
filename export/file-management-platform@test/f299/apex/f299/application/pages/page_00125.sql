...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3085193835478923072)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3085194009738923073)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3302178746837987031)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3085194009738923073)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3302178689337987030)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3085194009738923073)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3085194037056923074)
,p_name=>'P125_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3085193835478923072)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178280014987026)
,p_name=>'P125_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178344746987027)
,p_name=>'P125_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178438428987028)
,p_name=>'P125_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>140
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178623853987029)
,p_name=>'P125_COUNT'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178910456987032)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3302178927318987033)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3304001280377176662)
,p_name=>'P125_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3302179035818987034)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3302178689337987030)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179159258987035)
,p_event_id=>wwv_flow_imp.id(3302179035818987034)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3302179229795987036)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3302178746837987031)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3304001418069176663)
,p_event_id=>wwv_flow_imp.id(3302179229795987036)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179875944987042)
,p_event_id=>wwv_flow_imp.id(3302179229795987036)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2989453383493361675)
,p_event_id=>wwv_flow_imp.id(3302179229795987036)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179939688987043)
,p_event_id=>wwv_flow_imp.id(3302179229795987036)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179378521987037)
,p_event_id=>wwv_flow_imp.id(3302179229795987036)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3302179483341987038)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179613988987039)
,p_event_id=>wwv_flow_imp.id(3302179483341987038)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3302178746837987031)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3304413492129931735)
,p_event_id=>wwv_flow_imp.id(3302179483341987038)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3302179716254987040)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3302179729164987041)
,p_event_id=>wwv_flow_imp.id(3302179716254987040)
,p_event_result=>'TRUE'
,p_action_sequence=>10
