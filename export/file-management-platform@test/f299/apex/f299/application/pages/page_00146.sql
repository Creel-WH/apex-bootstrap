...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4056333551327383153)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4056333725587383154)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341476378276511624)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4056333725587383154)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341476053557511624)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4056333725587383154)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3341099946413236600)
,p_name=>'P146_FILE_ID'
,p_data_type=>'CLOB'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810305370663491025)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810305576250491027)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4056334987211383167)
,p_name=>'P146_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4056333551327383153)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4273322469614447123)
,p_name=>'P146_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4273322534346447124)
,p_name=>'P146_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4273322628028447125)
,p_name=>'P146_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4273322813453447126)
,p_name=>'P146_COUNT'
,p_item_sequence=>160
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4273323116918447130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4275145469976636759)
,p_name=>'P146_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341479445891511628)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341476053557511624)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341479895624511629)
,p_event_id=>wwv_flow_imp.id(3341479445891511628)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341480294349511629)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341476378276511624)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341480852658511629)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341481871212511630)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341482330731511630)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341102154120236622)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341102045630236621)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341481361834511629)
,p_event_id=>wwv_flow_imp.id(3341480294349511629)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341482761150511630)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341483711953511631)
,p_event_id=>wwv_flow_imp.id(3341482761150511630)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3341476378276511624)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341483225353511630)
,p_event_id=>wwv_flow_imp.id(3341482761150511630)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341484080621511631)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341484577546511632)
,p_event_id=>wwv_flow_imp.id(3341484080621511631)
,p_event_result=>'TRUE'
,p_action_sequence=>10
