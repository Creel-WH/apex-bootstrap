...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4022877204091960900)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4022877378351960901)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3308020031041089371)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4022877378351960901)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3308019706322089371)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4022877378351960901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3307643599177814347)
,p_name=>'P146_FILE_ID'
,p_data_type=>'CLOB'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3776849023428068772)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3776849229015068774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4022878639975960914)
,p_name=>'P146_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4022877204091960900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4239866122379024870)
,p_name=>'P146_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4239866187111024871)
,p_name=>'P146_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4239866280793024872)
,p_name=>'P146_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4239866466218024873)
,p_name=>'P146_COUNT'
,p_item_sequence=>160
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4239866769683024877)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4241689122741214506)
,p_name=>'P146_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308023098656089375)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3308019706322089371)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308023548389089376)
,p_event_id=>wwv_flow_imp.id(3308023098656089375)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308023947114089376)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3308020031041089371)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308024505423089376)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308025523977089377)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308025983496089377)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3307645806884814369)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3307645698394814368)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308025014599089376)
,p_event_id=>wwv_flow_imp.id(3308023947114089376)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308026413915089377)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308027364718089378)
,p_event_id=>wwv_flow_imp.id(3308026413915089377)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3308020031041089371)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308026878118089377)
,p_event_id=>wwv_flow_imp.id(3308026413915089377)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308027733386089378)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308028230311089379)
,p_event_id=>wwv_flow_imp.id(3308027733386089378)
,p_event_result=>'TRUE'
,p_action_sequence=>10
