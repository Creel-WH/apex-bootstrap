...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7998943477702409127)
,p_plug_name=>unistr('\95EE\9898\622A\5C4F\663E\793A')
,p_parent_plug_id=>wwv_flow_imp.id(8534198770559703376)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7998943564499409128)
,p_region_id=>wwv_flow_imp.id(7998943477702409127)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(7998944382005409136)
,p_card_id=>wwv_flow_imp.id(7998943564499409128)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7998943653293409129)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7998943815526409130)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7998943846928409131)
,p_region_id=>wwv_flow_imp.id(7998943815526409130)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(7998944294385409135)
,p_card_id=>wwv_flow_imp.id(7998943846928409131)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
,p_display_sequence=>10
,p_label=>unistr('\5220\9664')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8329408897454173335)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8329408990736173336)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8404004810268995024)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8534208227295703394)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8329392105411145187)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8534208227295703394)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8329392554980145187)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8329392952092145187)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8329393280851145187)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6504460534617285258)
,p_name=>'P902_REQ_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
,p_item_source_plug_id=>wwv_flow_imp.id(8534198770559703376)
,p_prompt=>unistr('\9700\6C42\7C7B\578B')
,p_source=>'REQ_TYPE'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>unistr('REQ_TYPE\FF08\9700\6C42\7C7B\578B\FF09')
,p_lov=>'.'||wwv_flow_imp.id(6434470850264137347)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8329408455703173330)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8329408479769173331)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8329408693118173333)
,p_name=>'P902_RESULT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8329408811755173334)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534199707710703379)
,p_name=>'P902_FB_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534200105933703386)
,p_name=>'P902_FB_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534200526139703390)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534200967707703391)
,p_name=>'P902_APP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534201347495703391)
,p_name=>'P902_PAGE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534201715479703391)
,p_name=>'P902_DETAIL'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>100
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534202174858703391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534203695509703392)
,p_name=>'P902_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8534204504930703392)
,p_name=>'P902_COMM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8329393997308145189)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8329394728776145189)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8329392105411145187)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8329395245321145189)
,p_event_id=>wwv_flow_imp.id(8329394728776145189)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8329395623176145189)
,p_name=>'upload_img_u'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8404004810268995024)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8329396127645145190)
,p_event_id=>wwv_flow_imp.id(8329395623176145189)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7998943985392409132)
,p_name=>'upload_img_d'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7998943653293409129)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7998944071588409133)
,p_event_id=>wwv_flow_imp.id(7998943985392409132)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8329390654160145186)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8534198770559703376)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8329394283874145189)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8329390207385145185)
,p_process_sequence=>10
