...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3294307290909346143)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3294307347063346144)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3294307901297346149)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3294307347063346144)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3294307809236346148)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3294307347063346144)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3294307493893346145)
,p_name=>'P121_FOLDER_LIB_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3294307290909346143)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3294307956390346150)
,p_name=>'P121_COUNT'
,p_item_sequence=>130
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3301283082306164630)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3294308088289346151)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3294307809236346148)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308190486346152)
,p_event_id=>wwv_flow_imp.id(3294308088289346151)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3294308302729346153)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3294307901297346149)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308406201346154)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308453357346155)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308616121346156)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2989451634290361658)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
...
'',
'    insert into FMP_FOLDER_LIB(FOLDER_LIB_NAME,',
'                               FOLDER_CLASS_ID,',
'                               FOLDER_LIB_STATUS,',
'                               DEL_FLAG,',
'                               SYSTEM_ID,',
...
'        FMP_SYNCHRONIZE_ACCOUNTS_PRO(ITEM.RANGE_TYPE, ITEM.RANGE_ID, :MPF_USER_ID, :USER_TENANT, ''FOLDER_LIB'');',
unistr('        --\6587\4EF6\7BA1\7406'),
'        FMP_SYNCHRONIZE_ACCOUNTS_PRO(ITEM.RANGE_TYPE, ITEM.RANGE_ID, :MPF_USER_ID, :USER_TENANT, ''FOLDER'');',
'    END LOOP;',
'    ',
'    end if;',
'    APEX_UTIL.SET_SESSION_STATE(''P121_COUNT'', 1);',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2989452486531361666)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308731384346158)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294308915688346159)
,p_event_id=>wwv_flow_imp.id(3294308302729346153)
,p_event_result=>'TRUE'
