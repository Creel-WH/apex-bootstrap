...
'    const breadcrumbWithTail = breadcrumbHtml ? breadcrumbHtml + ''<span class="p137-crumb-tail"><span class="fa fa-angle-right" aria-hidden="true"></span></span>'' : '''';',
'    const iconClass = ({',
'        PDF: ''fa-file-pdf-o'',',
'        DOC: ''fa-file-word-o'',',
'        DOCX: ''fa-file-word-o'',',
...
'',
'    $path.find(''.p137-crumbs'').html(breadcrumbWithTail);',
...
'}',
'',
'    function p137BindDetailOutsideClose() {',
'    $(document).off(''mousedown.p137detail'').on(''mousedown.p137detail'', function(event) {',
'        const $drawer = $(''#p137_detail_drawer'');',
...
'        }',
'',
'        if ($target.closest(''#p137_detail_drawer, #P137_BTN_DETAIL'').length) {',
'            return;',
'        }',
'',
...
'#p137_titlebar_path .p137-crumb-tail {',
'    display: inline-flex;',
'    align-items: center;',
'    color: #94a3b8;',
'    font-size: 12px;',
