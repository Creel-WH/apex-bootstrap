...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4276166305653796200)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4276166581841796202)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341524651820445734)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4276166581841796202)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341524992489445734)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341525429618445734)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810018104923336049)
,p_name=>'P142_TIPS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4276166305653796200)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810020195587336052)
,p_name=>'P142_MESSAGE'
,p_item_sequence=>150
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810020560261336055)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810020605058336056)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4276167641810796213)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4278522029860710596)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4278522105818710597)
,p_name=>'P142_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341527838184445740)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341525429618445734)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341529822713445741)
,p_event_id=>wwv_flow_imp.id(3341527838184445740)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341530309276445741)
,p_event_id=>wwv_flow_imp.id(3341527838184445740)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341528369890445740)
,p_event_id=>wwv_flow_imp.id(3341527838184445740)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341528793360445741)
,p_event_id=>wwv_flow_imp.id(3341527838184445740)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341529296141445741)
,p_event_id=>wwv_flow_imp.id(3341527838184445740)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341530740423445741)
,p_name=>unistr('\6267\884C\5F52\6863')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341524651820445734)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341531209982445741)
,p_event_id=>wwv_flow_imp.id(3341530740423445741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
