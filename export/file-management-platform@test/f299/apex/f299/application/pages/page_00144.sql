...
,p_group_id=>wwv_flow_imp.id(3709714614872861742)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4176909859491717080)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4176911797221717099)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3274909510557000118)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4176911797221717099)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3274909919112000127)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(959551622152432742)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274807044791867810)
,p_name=>'P144_FILE_ID'
,p_item_sequence=>190
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274942565930990588)
,p_name=>'P144_IS_IMMEDIATELY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(4176909859491717080)
,p_item_default=>'1'
,p_prompt=>unistr('\539F\6587\4EF6\662F\5426\7ACB\5373\5F52\6863')
,p_display_as=>'NATIVE_RADIOGROUP'
,p_lov=>unistr('STATIC2:\662F;1,\5426;0')
,p_field_template=>wwv_flow_imp.id(9726700343829842041)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275652476769223881)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275652491182223882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275652582654223883)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275652832661223885)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275652923216223886)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4176911519672717114)
,p_name=>'P144_FILE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(4176909859491717080)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4176913393374717122)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4181235513255252289)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4181235869996252293)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4181236002925252294)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4181236051714252295)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274912025707000143)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274912575486000143)
,p_event_id=>wwv_flow_imp.id(3274912025707000143)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274912917168000149)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274913397009000150)
,p_event_id=>wwv_flow_imp.id(3274912917168000149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274913968290000150)
,p_event_id=>wwv_flow_imp.id(3274912917168000149)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274914336335000150)
,p_event_id=>wwv_flow_imp.id(3274912917168000149)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274914793756000150)
,p_event_id=>wwv_flow_imp.id(3274912917168000149)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274915196649000150)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3274909510557000118)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274915768324000151)
,p_event_id=>wwv_flow_imp.id(3274915196649000150)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CLOSE_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4176909859491717080)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3274916130428000151)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3274909919112000127)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274916610991000152)
,p_event_id=>wwv_flow_imp.id(3274916130428000151)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3275652712369223884)
,p_event_id=>wwv_flow_imp.id(3274916130428000151)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(919996561927180322)
,p_event_id=>wwv_flow_imp.id(3274916130428000151)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274917636883000152)
,p_event_id=>wwv_flow_imp.id(3274916130428000151)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3274918170564000153)
,p_event_id=>wwv_flow_imp.id(3274916130428000151)
,p_event_result=>'TRUE'
