...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9760176353932264372)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760176662287264373)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760177034433264375)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760177278214264379)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760177547796264379)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760177885012264379)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760178227941264380)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760178461048264380)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9760178785579264381)
,p_plugin_id=>wwv_flow_imp.id(9760176353932264372)
,p_attribute_scope=>'COMPONENT'
