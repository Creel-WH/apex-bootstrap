...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9760062690659264244)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760063019185264244)
,p_plug_template_id=>wwv_flow_imp.id(9760062690659264244)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760063308073264245)
,p_plug_template_id=>wwv_flow_imp.id(9760062690659264244)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760063560629264245)
,p_plug_template_id=>wwv_flow_imp.id(9760062690659264244)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760063876883264245)
,p_plug_template_id=>wwv_flow_imp.id(9760062690659264244)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760064209574264245)
,p_plug_template_id=>wwv_flow_imp.id(9760062690659264244)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
