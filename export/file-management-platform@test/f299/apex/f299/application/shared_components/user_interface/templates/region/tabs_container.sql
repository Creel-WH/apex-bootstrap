...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9760095805010264254)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760096096655264254)
,p_plug_template_id=>wwv_flow_imp.id(9760095805010264254)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760096378184264254)
,p_plug_template_id=>wwv_flow_imp.id(9760095805010264254)
,p_name=>'Tabs'
