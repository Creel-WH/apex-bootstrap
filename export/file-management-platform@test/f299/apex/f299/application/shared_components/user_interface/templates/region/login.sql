...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9760080816980264249)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760081131551264250)
,p_plug_template_id=>wwv_flow_imp.id(9760080816980264249)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760081369536264250)
,p_plug_template_id=>wwv_flow_imp.id(9760080816980264249)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760081714259264250)
,p_plug_template_id=>wwv_flow_imp.id(9760080816980264249)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760082043806264250)
,p_plug_template_id=>wwv_flow_imp.id(9760080816980264249)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760082328343264250)
,p_plug_template_id=>wwv_flow_imp.id(9760080816980264249)
,p_name=>'Sub Regions'
