...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(9760143949189264282)
...
'</div>',
'<style>',
'#t_Body_nav{background:#fff;border-right:1px solid #e8e8e8;box-shadow:none;color:#666;}',
'#t_TreeNav{padding:10px 0;}',
'#t_Body_nav .a-TreeView-content,#t_Body_nav .a-TreeView-toggle,#t_Body_nav .fa,#t_Body_nav .a-Icon{color:#666 !important;}',
'#t_TreeNav .a-TreeView-row{display:none !important;}',
'#t_TreeNav .a-TreeView-content{margin:2px 12px;padding:10px 14px;border-radius:8px;color:#666 !important;transition:background-color .2s ease,color .2s ease;}',
'#t_TreeNav .a-TreeView-content:hover{background:#f0f7ff !important;}',
'#t_TreeNav .a-TreeView-content:hover,#t_TreeNav .a-TreeView-content:hover .a-TreeView-label,#t_TreeNav .a-TreeView-content:hover .a-TreeView-toggle,#t_TreeNav .a-TreeView-content:hover .fa,#t_TreeNav .a-TreeView-content:hover .a-Icon{color:#1890ff !important;}',
'#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content{background:#e6f7ff !important;color:#1890ff !important;}',
'#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content .a-TreeView-label,#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content .a-TreeView-toggle,#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content .fa,#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content .a-Icon,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content .a-TreeView-label,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content .a-TreeView-toggle,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content .fa,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content .a-Icon,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content .a-TreeView-label,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content .a-TreeView-toggle,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content .fa,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content .a-Icon{color:#1890ff !important;}',
'</style>',
'<script>',
'(() => {',
