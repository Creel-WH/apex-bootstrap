...
,p_group_id=>wwv_flow_imp.id(9763788895195153292)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(9763764701296540610)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(9763762983819540601)
,p_button_name=>'LOGIN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9763763515068540607)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9763762983819540601)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9763763911424540608)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9763764287397540609)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9763766878014540618)
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(9763767352156540618)
,p_page_process_id=>wwv_flow_imp.id(9763766878014540618)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(9763767897979540619)
,p_page_process_id=>wwv_flow_imp.id(9763766878014540618)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9763765007251540613)
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(9763765446933540616)
,p_page_process_id=>wwv_flow_imp.id(9763765007251540613)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(9763765937561540618)
,p_page_process_id=>wwv_flow_imp.id(9763765007251540613)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(9763766478337540618)
,p_page_process_id=>wwv_flow_imp.id(9763765007251540613)
,p_page_id=>9999
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9763768804674540619)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9763768400953540619)
,p_process_sequence=>20
