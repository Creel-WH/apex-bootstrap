...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9795452303591686468)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795452601796686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795452982507686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795453236033686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795453555970686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795453832768686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795454117928686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795454399984686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795454718740686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795455051139686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795455313147686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795455623911686469)
,p_page_template_id=>wwv_flow_imp.id(9795452303591686468)
