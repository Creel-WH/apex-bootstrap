...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9795463728501686472)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795464023801686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795464363858686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795464672659686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795464959697686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795465215194686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795465562947686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795465860391686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795466177165686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795466404727686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795466740654686473)
,p_page_template_id=>wwv_flow_imp.id(9795463728501686472)
