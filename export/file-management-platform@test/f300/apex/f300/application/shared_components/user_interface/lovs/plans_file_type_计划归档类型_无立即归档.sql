prompt --application/shared_components/user_interface/lovs/plans_file_type_计划归档类型_无立即归�?
begin
--   Manifest
--     PLANS_FILE_TYPE(计划归档类型-无立即归�?
--   Manifest End
