...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9795467184749686473)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795467455072686474)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795467702536686474)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795468054066686474)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795468317706686474)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795468642715686474)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795468906079686475)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795469257847686475)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795469531018686475)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795469888817686475)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795470103197686475)
,p_page_template_id=>wwv_flow_imp.id(9795467184749686473)
