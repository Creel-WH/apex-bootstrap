...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9795522512357686498)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795522868420686498)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795523185591686498)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795523397273686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795523766409686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795524028066686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795524327492686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795524633004686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795524926846686499)
,p_plug_template_id=>wwv_flow_imp.id(9795522512357686498)
,p_name=>'Sub Regions'
