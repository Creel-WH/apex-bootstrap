...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9795456079019686470)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795456331644686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795456603138686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795456932540686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795457239056686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795457571716686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795457855727686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795458166553686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795458407662686470)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795458768887686471)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795459068129686471)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795459323996686471)
,p_page_template_id=>wwv_flow_imp.id(9795456079019686470)
