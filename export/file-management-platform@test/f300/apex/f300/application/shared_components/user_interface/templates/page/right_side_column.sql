...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9731516163397393996)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731516416022393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731516687516393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731517016918393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731517323434393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731517656094393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731517940105393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731518250931393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731518492040393996)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731518853265393997)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731519152507393997)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731519408374393997)
,p_page_template_id=>wwv_flow_imp.id(9731516163397393996)
