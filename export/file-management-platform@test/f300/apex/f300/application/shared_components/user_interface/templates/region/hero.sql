...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9795519037894686497)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795519366420686497)
,p_plug_template_id=>wwv_flow_imp.id(9795519037894686497)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795519655308686498)
,p_plug_template_id=>wwv_flow_imp.id(9795519037894686497)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795519907864686498)
,p_plug_template_id=>wwv_flow_imp.id(9795519037894686497)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795520224118686498)
,p_plug_template_id=>wwv_flow_imp.id(9795519037894686497)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9795520556809686498)
,p_plug_template_id=>wwv_flow_imp.id(9795519037894686497)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
