...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9731579122272394023)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731579450798394023)
,p_plug_template_id=>wwv_flow_imp.id(9731579122272394023)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731579739686394024)
,p_plug_template_id=>wwv_flow_imp.id(9731579122272394023)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731579992242394024)
,p_plug_template_id=>wwv_flow_imp.id(9731579122272394023)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731580308496394024)
,p_plug_template_id=>wwv_flow_imp.id(9731579122272394023)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731580641187394024)
,p_plug_template_id=>wwv_flow_imp.id(9731579122272394023)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
