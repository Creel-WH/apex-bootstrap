...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(9795728546302686797)
,p_name=>unistr('\5BFC\822A\680F')
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(9795740543912686873)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(9795741065937686873)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(9795740543912686873)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(9801644379532690227)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(9795741398516686874)
