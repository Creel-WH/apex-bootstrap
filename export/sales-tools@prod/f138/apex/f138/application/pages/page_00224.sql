...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10864373026577438559)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10864380326976438571)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3241912659598611853)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10864380326976438571)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3241913060598611854)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3241913430858611854)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3241913855057611854)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3241091355985359202)
,p_name=>'P224_CREATION_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(10864373026577438559)
,p_item_source_plug_id=>wwv_flow_imp.id(10864373026577438559)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3241091444755359203)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10242082403554623274)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864018616407790886)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864375057147438567)
,p_name=>'P224_USER_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864375871745438568)
,p_name=>'P224_REMARK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864376301241438569)
...
,p_lov=>'.'||wwv_flow_imp.id(9261409976012444866)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_imp.id(9258910567250615404)
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864377081020438569)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10864377854869438570)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10865039992791231279)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10865040112221231280)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10865040203493231281)
,p_name=>'P224_ROLE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(10864373026577438559)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10865040273354231282)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3241915148468611855)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3241912659598611853)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241915649518611855)
,p_event_id=>wwv_flow_imp.id(3241915148468611855)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3241916062206611855)
,p_name=>unistr('\65B0\589E\6570\636E')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3241913855057611854)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241916521353611855)
,p_event_id=>wwv_flow_imp.id(3241916062206611855)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241917018125611855)
,p_event_id=>wwv_flow_imp.id(3241916062206611855)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803216613708051338)
,p_event_id=>wwv_flow_imp.id(3241916062206611855)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241917539902611856)
,p_event_id=>wwv_flow_imp.id(3241916062206611855)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241918100985611856)
,p_event_id=>wwv_flow_imp.id(3241916062206611855)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3241918459559611856)
,p_name=>unistr('\4FEE\6539\6570\636E ')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3241913430858611854)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241918911568611856)
,p_event_id=>wwv_flow_imp.id(3241918459559611856)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241919418341611856)
,p_event_id=>wwv_flow_imp.id(3241918459559611856)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241919986515611856)
,p_event_id=>wwv_flow_imp.id(3241918459559611856)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241920482187611857)
,p_event_id=>wwv_flow_imp.id(3241918459559611856)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3241920891614611857)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241921375574611857)
,p_event_id=>wwv_flow_imp.id(3241920891614611857)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(10864373026577438559)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3241921752157611857)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3241922228815611857)
,p_event_id=>wwv_flow_imp.id(3241921752157611857)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3241912054505611853)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(10864373026577438559)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3241914738354611854)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3241911611596611853)
,p_process_sequence=>10
