...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709645762820081876)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3273787915096340845)
,p_name=>'DING_USER_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709645931536081878)
,p_name=>'FEEDBACK_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646079479081879)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646161635081880)
,p_name=>'FOLDER_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646330148081882)
,p_name=>'USER_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646483562081883)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646580094081884)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646591252081885)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646781788081886)
,p_name=>'PROCESS_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709646866156081887)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709647165334081890)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3709648392790081903)
,p_name=>'OPERATION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3709645808190081877)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3713901372327177410)
,p_interactive_grid_id=>wwv_flow_imp.id(3709645808190081877)
,p_static_id=>'4544752'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3713901568921177411)
,p_report_id=>wwv_flow_imp.id(3713901372327177410)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2807647223508469680)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(3273787915096340845)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713902085130177415)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3709645931536081878)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713902923724177420)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3709646079479081879)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713903792951177423)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3709646161635081880)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713905666760177428)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3709646330148081882)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>155.125
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713906503754177430)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3709646483562081883)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713907426713177432)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(3709646580094081884)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713908312745177435)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3709646591252081885)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>173
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713909252070177437)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(3709646781788081886)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>166
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713910140988177439)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(3709646866156081887)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713917977004348238)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3709647165334081890)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3713934006095528934)
,p_view_id=>wwv_flow_imp.id(3713901568921177411)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(3709648392790081903)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3262198128432857816)
,p_name=>'P203_URL'
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709653826941082081)
,p_name=>'P203_STATUS'
,p_item_sequence=>100
,p_item_default=>'99'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807653121670365108)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807653556922365109)
,p_event_id=>wwv_flow_imp.id(2807653121670365108)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3709645762820081876)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807653896262365218)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807654333309365218)
,p_event_id=>wwv_flow_imp.id(2807653896262365218)
,p_event_result=>'TRUE'
,p_action_sequence=>10
