...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(452413222800096878)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940212541210703936)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940212684436703937)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6315328374745624359)
,p_name=>'P0_APP_CODE'
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390786473808708788)
,p_name=>'P0_APP_ENV'
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390786614077708790)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390786790139708791)
,p_name=>'P0_USER_NAME'
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390786887661708792)
,p_name=>'P0_USER_ID'
,p_item_sequence=>50
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390786897741708793)
,p_name=>'P0_APP_NAME'
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390787076461708794)
,p_name=>'P0_APP_ID'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7390787153410708795)
