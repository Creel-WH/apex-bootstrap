...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3272544528634625605)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3272544804822625607)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806395173180165445)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3272544804822625607)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806403260050649684)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806403673841649686)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806395464971165448)
,p_name=>'P141_MESSAGE'
,p_item_sequence=>150
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806395606724165449)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806395722257165450)
,p_name=>'P141_TIPS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3272544528634625605)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806395829645165451)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806395874442165452)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2807154133622763975)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2807154265524763977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274897299244539992)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3274897375202539993)
,p_name=>'P141_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806404916465649691)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806403673841649686)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806405359311649692)
,p_event_id=>wwv_flow_imp.id(2806404916465649691)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806405910761649693)
,p_event_id=>wwv_flow_imp.id(2806404916465649691)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806406351128649693)
,p_event_id=>wwv_flow_imp.id(2806404916465649691)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806406885881649693)
,p_event_id=>wwv_flow_imp.id(2806404916465649691)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806407354515649693)
,p_event_id=>wwv_flow_imp.id(2806404916465649691)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806395308100165446)
,p_name=>unistr('\6267\884C\5F52\6863')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806395173180165445)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806395375574165447)
,p_event_id=>wwv_flow_imp.id(2806395308100165446)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807151287004763947)
,p_name=>unistr('\70B9\51FB\53D6\6D88')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806403260050649684)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807151403133763948)
,p_event_id=>wwv_flow_imp.id(2807151287004763947)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
