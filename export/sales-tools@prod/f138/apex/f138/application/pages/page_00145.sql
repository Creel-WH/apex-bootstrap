...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3741235831133888207)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3741236107321888209)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806594606956537742)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3741236107321888209)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806595032867537742)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275087641627428055)
,p_name=>'P145_FILE_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3741235831133888207)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3741237178514888219)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3743591513876802601)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3743591589834802602)
,p_name=>'P145_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806597431924537744)
,p_name=>unistr('\8BBE\7F6E\591A\8BED\8A00')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806595032867537742)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806599420195537750)
,p_event_id=>wwv_flow_imp.id(2806597431924537744)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806597853396537745)
,p_event_id=>wwv_flow_imp.id(2806597431924537744)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806598340781537748)
,p_event_id=>wwv_flow_imp.id(2806597431924537744)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806598935826537748)
,p_event_id=>wwv_flow_imp.id(2806597431924537744)
,p_event_result=>'TRUE'
