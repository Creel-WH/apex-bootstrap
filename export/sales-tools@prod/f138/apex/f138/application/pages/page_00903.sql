...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7489098507595600346)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7828160250029524430)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(7828160443202524432)
,p_name=>'MIME_TYPE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(7828160666037524434)
,p_name=>'FILE_NAME'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(7828160860913524436)
,p_name=>'FB_IMG_ID'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(7828160925286524437)
,p_name=>'FB_IMG'
,p_data_type=>'BLOB'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7489098132174600342)
,p_name=>'P903_ENTRY_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7489098507595600346)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7489098151784600343)
,p_name=>'P903_DETAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7489098507595600346)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7828160765323524435)
,p_name=>'P903_FB_ID'
,p_item_sequence=>30
