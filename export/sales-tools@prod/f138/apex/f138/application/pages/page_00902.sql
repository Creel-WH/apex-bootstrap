...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7497696090266760235)
,p_plug_name=>unistr('\95EE\9898\622A\5C4F\663E\793A')
,p_parent_plug_id=>wwv_flow_imp.id(8032951383124054484)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7497696177063760236)
,p_region_id=>wwv_flow_imp.id(7497696090266760235)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(7497696994569760244)
,p_card_id=>wwv_flow_imp.id(7497696177063760236)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7497696265857760237)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7497696428090760238)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7497696459492760239)
,p_region_id=>wwv_flow_imp.id(7497696428090760238)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(7497696906949760243)
,p_card_id=>wwv_flow_imp.id(7497696459492760239)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
,p_display_sequence=>10
,p_label=>unistr('\5220\9664')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7828161510018524443)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7828161603300524444)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7902757422833346132)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8032960839860054502)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7828144717975496295)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8032960839860054502)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7828145167544496295)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7828145564656496295)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7828145893415496295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6003213147181636366)
,p_name=>'P902_REQ_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
,p_item_source_plug_id=>wwv_flow_imp.id(8032951383124054484)
,p_prompt=>unistr('\9700\6C42\7C7B\578B')
,p_source=>'REQ_TYPE'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>unistr('REQ_TYPE\FF08\9700\6C42\7C7B\578B\FF09')
,p_lov=>'.'||wwv_flow_imp.id(5933223462828488455)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7828161068267524438)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7828161092333524439)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7828161305682524441)
,p_name=>'P902_RESULT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7828161424319524442)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032952320275054487)
,p_name=>'P902_FB_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032952718498054494)
,p_name=>'P902_FB_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032953138704054498)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032953580272054499)
,p_name=>'P902_APP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032953960060054499)
,p_name=>'P902_PAGE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032954328044054499)
,p_name=>'P902_DETAIL'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>100
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032954787423054499)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032956308074054500)
,p_name=>'P902_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8032957117495054500)
,p_name=>'P902_COMM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(7828146609872496297)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7828147341340496297)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(7828144717975496295)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7828147857885496297)
,p_event_id=>wwv_flow_imp.id(7828147341340496297)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7828148235740496297)
,p_name=>'upload_img_u'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7902757422833346132)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7828148740209496298)
,p_event_id=>wwv_flow_imp.id(7828148235740496297)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7497696597956760240)
,p_name=>'upload_img_d'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7497696265857760237)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7497696684152760241)
,p_event_id=>wwv_flow_imp.id(7497696597956760240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7828143266724496294)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8032951383124054484)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7828146896438496297)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7828142819949496293)
,p_process_sequence=>10
