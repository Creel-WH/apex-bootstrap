...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258850974681615363)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258851286489615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258851646323615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258851868508615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258852175060615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258852527028615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258852762889615363)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258853146272615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258853377787615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258853700421615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258854010399615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258854350871615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258854631190615364)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258854936931615365)
,p_plug_template_id=>wwv_flow_imp.id(9258850974681615363)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
