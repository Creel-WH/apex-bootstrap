...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258848417574615362)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258848709219615362)
,p_plug_template_id=>wwv_flow_imp.id(9258848417574615362)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258848990748615362)
,p_plug_template_id=>wwv_flow_imp.id(9258848417574615362)
,p_name=>'Tabs'
