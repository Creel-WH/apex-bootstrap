...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258833429544615357)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258833744115615358)
,p_plug_template_id=>wwv_flow_imp.id(9258833429544615357)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258833982100615358)
,p_plug_template_id=>wwv_flow_imp.id(9258833429544615357)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258834326823615358)
,p_plug_template_id=>wwv_flow_imp.id(9258833429544615357)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258834656370615358)
,p_plug_template_id=>wwv_flow_imp.id(9258833429544615357)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258834940907615358)
,p_plug_template_id=>wwv_flow_imp.id(9258833429544615357)
,p_name=>'Sub Regions'
