...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258799022678615346)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258799259221615347)
,p_plug_template_id=>wwv_flow_imp.id(9258799022678615346)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258799572315615347)
,p_plug_template_id=>wwv_flow_imp.id(9258799022678615346)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258799935747615347)
,p_plug_template_id=>wwv_flow_imp.id(9258799022678615346)
,p_name=>'Sub Regions'
