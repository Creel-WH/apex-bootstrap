...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258835887367615358)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258836186498615358)
,p_plug_template_id=>wwv_flow_imp.id(9258835887367615358)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258836496179615359)
,p_plug_template_id=>wwv_flow_imp.id(9258835887367615358)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258836802631615359)
,p_plug_template_id=>wwv_flow_imp.id(9258835887367615358)
,p_name=>'Sub Regions'
