...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258830873498615357)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8562365288535319793)
,p_plug_template_id=>wwv_flow_imp.id(9258830873498615357)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258831184198615357)
,p_plug_template_id=>wwv_flow_imp.id(9258830873498615357)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258831516576615357)
,p_plug_template_id=>wwv_flow_imp.id(9258830873498615357)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258831813436615357)
,p_plug_template_id=>wwv_flow_imp.id(9258830873498615357)
,p_name=>'Button Start'
