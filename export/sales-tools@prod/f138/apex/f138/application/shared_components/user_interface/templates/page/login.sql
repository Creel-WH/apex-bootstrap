...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9258744477308615321)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258744806338615321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258745134541615321)
,p_page_template_id=>wwv_flow_imp.id(9258744477308615321)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258745437262615322)
,p_page_template_id=>wwv_flow_imp.id(9258744477308615321)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258745711866615322)
,p_page_template_id=>wwv_flow_imp.id(9258744477308615321)
,p_name=>'Body Footer'
