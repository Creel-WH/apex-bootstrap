...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8567694361396113742)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8567694620597119582)
,p_plugin_id=>wwv_flow_imp.id(8567694361396113742)
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(7296683725128704630)
,p_plugin_id=>wwv_flow_imp.id(8567694361396113742)
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(8567694969415123851)
,p_plugin_id=>wwv_flow_imp.id(8567694361396113742)
