...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9258928966496615480)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258929274851615481)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258929646997615483)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258929890778615487)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258930160360615487)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258930497576615487)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258930840505615488)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258931073612615488)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9258931398143615489)
,p_plugin_id=>wwv_flow_imp.id(9258928966496615480)
,p_attribute_scope=>'COMPONENT'
