...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13030001000000000001)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13030001000000000002)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(13030001000000000006)
,p_name=>unistr('\5206\5E73\53F0\62A5\8868')
,p_region_name=>'p300-report'
,p_template=>wwv_flow_imp.id(9793532524250686501)
...
unistr('       ''<div class="p300-op-cell"><button type="button" class="p300-op p300-op-enter" data-act="enter" data-id="'' || s.system_id || ''" data-url="'' || apex_escape.html_attribute(apex_util.prepare_url(p_url => ''f?p=138:9999:0:P300_HANDOFF:'' || v(''DEBUG'') || '':9999:P9999_HANDOFF_USER,P9999_HANDOFF_SYSTEM_ID:'' || nvl(v(''USER_JOB_NUMBER''), v(''APP_USER'')) || '','' || s.system_id, p_checksum_type => ''PUBLIC_BOOKMARK'')) || ''"><span class="fa fa-external-link" aria-hidden="true"></span><span>\8FDB\5165</span></button><button type="button" class="p300-op p300-op-edit" data-act="edit" data-url="'' || apex_escape.html_attribute(apex_page.get_url(p_page => 301, p_items => ''P301_SYSTEM_ID'', p_values => s.system_id)) || ''"><span class="fa fa-pencil" aria-hidden="true"></span><span>\7F16\8F91</span></button><button type="button" class="p300-op p300-op-delete" data-act="delete" data-id="'' || s.system_id || ''"><span class="fa fa-trash-o" aria-hidden="true"></span><span>\5220\9664</span></button></div>'' as operation_html'),
'  from sts_system s',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(13030001000000000007)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(13030001000000000008)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(13030001000000000009)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(13030001000000000010)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(13030001000000000011)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(13030001000000000012)
,p_name=>unistr('\5206\5E73\53F0\5BF9\8BDD\6846\5173\95ED\540E\5237\65B0')
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(13030001000000000006)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(13030001000000000013)
,p_event_id=>wwv_flow_imp.id(13030001000000000012)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(13030001000000000006)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(13030001000000000005)
