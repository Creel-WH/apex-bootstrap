...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(10249505710034239656)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_imp.id(10249666443827239752)
...
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(10249794693705240014)
,p_nav_bar_list_template_id=>wwv_flow_imp.id(10249669303107239754)
