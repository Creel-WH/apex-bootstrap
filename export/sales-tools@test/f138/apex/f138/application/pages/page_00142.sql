...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4732232453056349417)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4732232729244349419)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3797590799222998951)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4732232729244349419)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3797591139891998951)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3797591577020998951)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266084252325889266)
,p_name=>'P142_TIPS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4732232453056349417)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266086342989889269)
,p_name=>'P142_MESSAGE'
,p_item_sequence=>150
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266086707663889272)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266086752460889273)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4732233789213349430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4734588177263263813)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4734588253221263814)
,p_name=>'P142_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797593985586998957)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3797591577020998951)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797595970115998958)
,p_event_id=>wwv_flow_imp.id(3797593985586998957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797596456678998958)
,p_event_id=>wwv_flow_imp.id(3797593985586998957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797594517292998957)
,p_event_id=>wwv_flow_imp.id(3797593985586998957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797594940762998958)
,p_event_id=>wwv_flow_imp.id(3797593985586998957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797595443543998958)
,p_event_id=>wwv_flow_imp.id(3797593985586998957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797596887825998958)
,p_name=>unistr('\6267\884C\5F52\6863')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3797590799222998951)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797597357384998958)
,p_event_id=>wwv_flow_imp.id(3797596887825998958)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
