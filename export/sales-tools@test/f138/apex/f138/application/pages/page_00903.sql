...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7945164654998153563)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8284226397432077647)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8284226590605077649)
,p_name=>'MIME_TYPE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8284226813440077651)
,p_name=>'FILE_NAME'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8284227008316077653)
,p_name=>'FB_IMG_ID'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8284227072689077654)
,p_name=>'FB_IMG'
,p_data_type=>'BLOB'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7945164279577153559)
,p_name=>'P903_ENTRY_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7945164654998153563)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7945164299187153560)
,p_name=>'P903_DETAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7945164654998153563)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8284226912726077652)
,p_name=>'P903_FB_ID'
,p_item_sequence=>30
