...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8479868389669224708)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8818930132103148792)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8818930325276148794)
,p_name=>'MIME_TYPE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8818930548111148796)
,p_name=>'FILE_NAME'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8818930742987148798)
,p_name=>'FB_IMG_ID'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8818930807360148799)
,p_name=>'FB_IMG'
,p_data_type=>'BLOB'
,p_session_state_data_type=>'VARCHAR2'
,p_is_visible=>true
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8479868014248224704)
,p_name=>'P903_ENTRY_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8479868389669224708)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8479868033858224705)
,p_name=>'P903_DETAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8479868389669224708)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8818930647397148797)
,p_name=>'P903_FB_ID'
,p_item_sequence=>30
