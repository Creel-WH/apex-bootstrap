...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4197301978536441424)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4197302254724441426)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3262660754359090959)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4197302254724441426)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3262661180270090959)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3731153789029981272)
,p_name=>'P145_FILE_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4197301978536441424)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4197303325917441436)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4199657661279355818)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4199657737237355819)
,p_name=>'P145_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3262663579327090961)
,p_name=>unistr('\8BBE\7F6E\591A\8BED\8A00')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3262661180270090959)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3262665567598090967)
,p_event_id=>wwv_flow_imp.id(3262663579327090961)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3262664000799090962)
,p_event_id=>wwv_flow_imp.id(3262663579327090961)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3262664488184090965)
,p_event_id=>wwv_flow_imp.id(3262663579327090961)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3262665083229090965)
,p_event_id=>wwv_flow_imp.id(3262663579327090961)
,p_event_result=>'TRUE'
