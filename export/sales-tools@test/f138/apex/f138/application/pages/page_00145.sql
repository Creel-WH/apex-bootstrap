...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4275939565804959352)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4275939841992959354)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341298341627608887)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4275939841992959354)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341298767538608887)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3809791376298499200)
,p_name=>'P145_FILE_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4275939565804959352)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4275940913185959364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4278295248547873746)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4278295324505873747)
,p_name=>'P145_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341301166595608889)
,p_name=>unistr('\8BBE\7F6E\591A\8BED\8A00')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341298767538608887)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341303154866608895)
,p_event_id=>wwv_flow_imp.id(3341301166595608889)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341301588067608890)
,p_event_id=>wwv_flow_imp.id(3341301166595608889)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341302075452608893)
,p_event_id=>wwv_flow_imp.id(3341301166595608889)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341302670497608893)
,p_event_id=>wwv_flow_imp.id(3341301166595608889)
,p_event_result=>'TRUE'
