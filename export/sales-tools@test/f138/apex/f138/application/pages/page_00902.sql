...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8032399824937831380)
,p_plug_name=>unistr('\95EE\9898\622A\5C4F\663E\793A')
,p_parent_plug_id=>wwv_flow_imp.id(8567655117795125629)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(8032399911734831381)
,p_region_id=>wwv_flow_imp.id(8032399824937831380)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(8032400729240831389)
,p_card_id=>wwv_flow_imp.id(8032399911734831381)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8032400000528831382)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8032400162761831383)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(8032400194163831384)
,p_region_id=>wwv_flow_imp.id(8032400162761831383)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(8032400641620831388)
,p_card_id=>wwv_flow_imp.id(8032400194163831384)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
,p_display_sequence=>10
,p_label=>unistr('\5220\9664')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8362865244689595588)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8362865337971595589)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8437461157504417277)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8567664574531125647)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8362848452646567440)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8567664574531125647)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8362848902215567440)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8362849299327567440)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8362849628086567440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6537916881852707511)
,p_name=>'P902_REQ_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
,p_item_source_plug_id=>wwv_flow_imp.id(8567655117795125629)
,p_prompt=>unistr('\9700\6C42\7C7B\578B')
,p_source=>'REQ_TYPE'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>unistr('REQ_TYPE\FF08\9700\6C42\7C7B\578B\FF09')
,p_lov=>'.'||wwv_flow_imp.id(6467927197499559600)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8362864802938595583)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8362864827004595584)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8362865040353595586)
,p_name=>'P902_RESULT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8362865158990595587)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567656054946125632)
,p_name=>'P902_FB_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567656453169125639)
,p_name=>'P902_FB_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567656873375125643)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567657314943125644)
,p_name=>'P902_APP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567657694731125644)
,p_name=>'P902_PAGE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567658062715125644)
,p_name=>'P902_DETAIL'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>100
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567658522094125644)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567660042745125645)
,p_name=>'P902_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8567660852166125645)
,p_name=>'P902_COMM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8362850344543567442)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8362851076011567442)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8362848452646567440)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8362851592556567442)
,p_event_id=>wwv_flow_imp.id(8362851076011567442)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8362851970411567442)
,p_name=>'upload_img_u'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8437461157504417277)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8362852474880567443)
,p_event_id=>wwv_flow_imp.id(8362851970411567442)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8032400332627831385)
,p_name=>'upload_img_d'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8032400000528831382)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'PLUGIN_DE.DANIELH.DROPZONE2|REGION TYPE|dropzone-upload-complete'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8032400418823831386)
,p_event_id=>wwv_flow_imp.id(8032400332627831385)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8362847001395567439)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8567655117795125629)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8362850631109567442)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8362846554620567438)
,p_process_sequence=>10
