...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1442972246834578013)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1442972361979578014)
,p_plug_name=>unistr('\6587\4EF6\7ED3\6784\6811')
,p_parent_plug_id=>wwv_flow_imp.id(1442972246834578013)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1442972886102578020)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1442972361979578014)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1442973155609578022)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1442972395953578015)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1442972506219578016)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1442974020480578031)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1442974147132578032)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1442974239082578033)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1442973199179578023)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1442972886102578020)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1442973280940578024)
,p_event_id=>wwv_flow_imp.id(1442973199179578023)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1442973460363578025)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1442973155609578022)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1442973557724578026)
,p_event_id=>wwv_flow_imp.id(1442973460363578025)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1442973916339578030)
,p_event_id=>wwv_flow_imp.id(1442973460363578025)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1442973731996578028)
,p_event_id=>wwv_flow_imp.id(1442973460363578025)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1442974320965578034)
,p_event_id=>wwv_flow_imp.id(1442973460363578025)
,p_event_result=>'TRUE'
