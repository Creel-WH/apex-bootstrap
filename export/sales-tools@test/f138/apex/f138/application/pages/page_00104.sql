...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3040010483775827375)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3040010814049827379)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3040010889534827380)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3040010814049827379)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3040011069474827381)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3040010814049827379)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3040010568727827376)
,p_name=>'P104_SORT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3040010483775827375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3040010625089827377)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3040010702695827378)
,p_name=>'P104_COUNT'
,p_item_sequence=>110
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3040011094681827382)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3040010889534827380)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3040011267050827383)
,p_event_id=>wwv_flow_imp.id(3040011094681827382)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3040011347210827384)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3040011069474827381)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3040011792973827389)
,p_event_id=>wwv_flow_imp.id(3040011347210827384)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3040011767385827388)
,p_event_id=>wwv_flow_imp.id(3040011347210827384)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3040011670025827387)
,p_event_id=>wwv_flow_imp.id(3040011347210827384)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3040011453244827385)
,p_event_id=>wwv_flow_imp.id(3040011347210827384)
,p_event_result=>'TRUE'
