...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1931164602409749294)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1931164717554749295)
,p_plug_name=>unistr('\6587\4EF6\7ED3\6784\6811')
,p_parent_plug_id=>wwv_flow_imp.id(1931164602409749294)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1928781039409638234)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1931164717554749295)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1928781422820638257)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1931164717554749295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1931166682648749424)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1931166792914749425)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1931168307175749440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1931168433827749441)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1931168525777749442)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1928783860665638319)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1928781039409638234)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1928784344162638335)
,p_event_id=>wwv_flow_imp.id(1928783860665638319)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1928784712790638338)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1928781422820638257)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1928785258041638340)
,p_event_id=>wwv_flow_imp.id(1928784712790638338)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1928786171434638341)
,p_event_id=>wwv_flow_imp.id(1928784712790638338)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1928785701761638340)
,p_event_id=>wwv_flow_imp.id(1928784712790638338)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1928786754886638369)
,p_event_id=>wwv_flow_imp.id(1928784712790638338)
,p_event_result=>'TRUE'
