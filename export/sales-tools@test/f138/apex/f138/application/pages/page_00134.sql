...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3794766088353382564)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3794766151683382565)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341286093030991264)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3794766151683382565)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3341285693221991263)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3794766151683382565)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3341220891969566415)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794766815419382573)
,p_name=>'P134_FILE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3794766088353382564)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794769156939382596)
,p_name=>'P134_COUNT'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341286973887991272)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341285693221991263)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341287479190991273)
,p_event_id=>wwv_flow_imp.id(3341286973887991272)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3341287919770991273)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3341286093030991264)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341289883229991276)
,p_event_id=>wwv_flow_imp.id(3341287919770991273)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341289372219991276)
,p_event_id=>wwv_flow_imp.id(3341287919770991273)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341288439044991274)
,p_event_id=>wwv_flow_imp.id(3341287919770991273)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3341288874785991276)
,p_event_id=>wwv_flow_imp.id(3341287919770991273)
,p_event_result=>'TRUE'
