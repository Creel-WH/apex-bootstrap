...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10249618299648239724)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249618591293239724)
,p_plug_template_id=>wwv_flow_imp.id(10249618299648239724)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249618872822239724)
,p_plug_template_id=>wwv_flow_imp.id(10249618299648239724)
,p_name=>'Tabs'
