...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9714914564977168579)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714914856622168579)
,p_plug_template_id=>wwv_flow_imp.id(9714914564977168579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714915138151168579)
,p_plug_template_id=>wwv_flow_imp.id(9714914564977168579)
,p_name=>'Tabs'
