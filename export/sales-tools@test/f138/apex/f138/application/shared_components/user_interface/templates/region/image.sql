...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10249554779391239704)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249555101388239704)
,p_plug_template_id=>wwv_flow_imp.id(10249554779391239704)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249555343605239704)
,p_plug_template_id=>wwv_flow_imp.id(10249554779391239704)
,p_name=>'Sub Regions'
