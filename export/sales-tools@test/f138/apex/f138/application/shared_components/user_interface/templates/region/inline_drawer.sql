...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10249588659760239715)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249589015823239715)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249589332994239715)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249589544676239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249589913812239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249590175469239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249590474895239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249590780407239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249591074249239716)
,p_plug_template_id=>wwv_flow_imp.id(10249588659760239715)
,p_name=>'Sub Regions'
