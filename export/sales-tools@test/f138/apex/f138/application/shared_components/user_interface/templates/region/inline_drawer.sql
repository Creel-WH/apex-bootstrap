...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9714884925089168570)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714885281152168570)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714885598323168570)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714885810005168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714886179141168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714886440798168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714886740224168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714887045736168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714887339578168571)
,p_plug_template_id=>wwv_flow_imp.id(9714884925089168570)
,p_name=>'Sub Regions'
