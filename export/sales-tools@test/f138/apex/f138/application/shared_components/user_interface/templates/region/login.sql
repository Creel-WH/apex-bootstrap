...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9714899576947168574)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714899891518168575)
,p_plug_template_id=>wwv_flow_imp.id(9714899576947168574)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714900129503168575)
,p_plug_template_id=>wwv_flow_imp.id(9714899576947168574)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714900474226168575)
,p_plug_template_id=>wwv_flow_imp.id(9714899576947168574)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714900803773168575)
,p_plug_template_id=>wwv_flow_imp.id(9714899576947168574)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714901088310168575)
,p_plug_template_id=>wwv_flow_imp.id(9714899576947168574)
,p_name=>'Sub Regions'
