...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10249603311618239719)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249603626189239720)
,p_plug_template_id=>wwv_flow_imp.id(10249603311618239719)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249603864174239720)
,p_plug_template_id=>wwv_flow_imp.id(10249603311618239719)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249604208897239720)
,p_plug_template_id=>wwv_flow_imp.id(10249603311618239719)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249604538444239720)
,p_plug_template_id=>wwv_flow_imp.id(10249603311618239719)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249604822981239720)
,p_plug_template_id=>wwv_flow_imp.id(10249603311618239719)
,p_name=>'Sub Regions'
