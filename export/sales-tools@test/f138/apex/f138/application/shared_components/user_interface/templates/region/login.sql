...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9793537164215686502)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9793537478786686503)
,p_plug_template_id=>wwv_flow_imp.id(9793537164215686502)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9793537716771686503)
,p_plug_template_id=>wwv_flow_imp.id(9793537164215686502)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9793538061494686503)
,p_plug_template_id=>wwv_flow_imp.id(9793537164215686502)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9793538391041686503)
,p_plug_template_id=>wwv_flow_imp.id(9793537164215686502)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9793538675578686503)
,p_plug_template_id=>wwv_flow_imp.id(9793537164215686502)
,p_name=>'Sub Regions'
