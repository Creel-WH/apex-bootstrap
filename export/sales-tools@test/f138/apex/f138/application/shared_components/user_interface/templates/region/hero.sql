...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9714881450626168569)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714881779152168569)
,p_plug_template_id=>wwv_flow_imp.id(9714881450626168569)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714882068040168570)
,p_plug_template_id=>wwv_flow_imp.id(9714881450626168569)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714882320596168570)
,p_plug_template_id=>wwv_flow_imp.id(9714881450626168569)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714882636850168570)
,p_plug_template_id=>wwv_flow_imp.id(9714881450626168569)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714882969541168570)
,p_plug_template_id=>wwv_flow_imp.id(9714881450626168569)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
