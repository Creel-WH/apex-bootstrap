...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(3265006241848184515)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(3265006475801184520)
,p_data_profile_id=>wwv_flow_imp.id(3265006241848184515)
,p_name=>'APP_NAME'
,p_sequence=>1
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(3265007306411184522)
,p_data_profile_id=>wwv_flow_imp.id(3265006241848184515)
,p_name=>'PAGE_ID'
,p_sequence=>2
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(3265006737844184521)
,p_data_profile_id=>wwv_flow_imp.id(3265006241848184515)
,p_name=>'CREATED_BY'
,p_sequence=>3
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(3265007020100184522)
,p_data_profile_id=>wwv_flow_imp.id(3265006241848184515)
,p_name=>'LOG_ID'
,p_sequence=>4
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(3265007649049184522)
,p_data_profile_id=>wwv_flow_imp.id(3265006241848184515)
,p_name=>'UPDATE_DATE'
,p_sequence=>5
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3265007969147184522)
,p_name=>unistr('\5BFC\5165\6A21\677F')
