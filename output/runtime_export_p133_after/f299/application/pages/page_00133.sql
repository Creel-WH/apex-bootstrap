...
,p_group_id=>wwv_flow_imp.id(3676257976175437553)
...
'    if (!$bar.length) {',
unistr('        if ($toolbar.length) { $toolbar.after(''<div id="p133_pathbar" class="p133-pathbar"><button type="button" class="p133-up" title="\8FD4\56DE\4E0A\4E00\7EA7" aria-label="\8FD4\56DE\4E0A\4E00\7EA7"><span class="fa fa-arrow-up" aria-hidden="true"></span></button><div class="p133-crumbs"')
||unistr('></div></div>''); } else { $anchor.before(''<div id="p133_pathbar" class="p133-pathbar"><button type="button" class="p133-up" title="\8FD4\56DE\4E0A\4E00\7EA7" aria-label="\8FD4\56DE\4E0A\4E00\7EA7"><span class="fa fa-arrow-up" aria-hidden="true"></span></button><div class="p133-crumbs"></di')
||'v></div>''); }',
'        $bar = $(''#p133_pathbar'');',
...
'',
'    if (manageFlag) {',
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="rename" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-pencil" aria-hidden="true"></spa'
||unistr('n><span>\91CD\547D\540D</span></button>'');'),
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="share" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-share-alt" aria-hidden="true"></s'
||unistr('pan><span>\5206\4EAB</span></button>'');'),
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="move" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-exchange" aria-hidden="true"></spa'
||unistr('n><span>\79FB\52A8\5230...</span></button>'');'),
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="settings" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-lock" aria-hidden="true"></spa'
||unistr('n><span>\6743\9650\8BBE\7F6E</span></button>'');'),
'        items.push(''<button type="button" class="p133-row-menu-item is-danger" data-p133-row-action="delete" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-trash-o" aria-hidden="'
||unistr('true"></span><span>\5220\9664</span></button>'');'),
'    } else {',
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="share" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-share-alt" aria-hidden="true"></s'
||unistr('pan><span>\5206\4EAB</span></button>'');'),
'        items.push(''<button type="button" class="p133-row-menu-item" data-p133-row-action="settings" data-file-id="'' + apex.util.escapeHTML(id) + ''" data-file-type="'' + apex.util.escapeHTML(type) + ''"><span class="fa fa-lock" aria-hidden="true"></spa'
...
'function p133SyncView() { if (window.p133SyncViewImpl) { return window.p133SyncViewImpl(); } }',
'function p133ScheduleViewSync() { if (window.p133ScheduleViewSyncImpl) { return window.p133ScheduleViewSyncImpl(); } }',
'function p133InitViewMode() { if (window.p133InitViewModeImpl) { return window.p133InitViewModeImpl(); } }',
'',
''))
...
unistr('                    apex.message.showPageSuccess(''\5220\9664\6210\529F\FF01'');'),
'                    p133RefreshContent();',
'                    window.setTimeout(function() { p133ScheduleViewSync(); }, 250);',
'                    return;',
'                }',
unistr('                apex.message.alert((resp && resp.message) || ''\5220\9664\5931\8D25\FF01'');'),
'            },',
...
'}',
'',
'function p133OpenActionUrl(actionName) {',
...
'    [0, 120, 320].forEach(function(delay) { window.setTimeout(p133SyncView, delay); });',
'};',
'',
...
'    $(document).off(''click.p133rowmenu'', ''#p133_row_menu [data-p133-row-action]'').on(''click.p133rowmenu'', ''#p133_row_menu [data-p133-row-action]'', function(event) { event.preventDefault(); event.stopPropagation(); p133HideRowMenu(); p133RunSingleActi'
||'on($(this).data(''p133RowAction''), $(this).data(''fileId''), $(this).data(''fileType'')); });',
...
'    $(document).off(''dblclick.p133fileopen'', ''#content .p133-file-open'').on(''dblclick.p133fileopen'', ''#content .p133-file-open'', function(event) { event.preventDefault(); event.stopPropagation(); p133OpenEntry($(this).data(''fileId''), $(this).data(''fi'
||'leType'')); });',
'    $(document).off(''dblclick.p133cardopen'', ''#p133_grid_view .p133-card-open'').on(''dblclick.p133cardopen'', ''#p133_grid_view .p133-card-open'', function(event) { event.preventDefault(); event.stopPropagation(); p133OpenEntry($(this).data(''fileId''), $('
||'this).data(''fileType'')); });',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(787632288293733242)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(787632288293733243)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733245)
,p_name=>'UPDATE_DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733246)
,p_name=>'UPDATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733247)
,p_name=>'FILE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733248)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733249)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733250)
,p_name=>'FILE_NAME'
,p_source_type=>'DB_COLUMN'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'html_expression', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    '    <button type="button" class="p133-row-action-btn" data-can-manage="&IS_PERMISSIONS." onclick="p133RunSingleAction(''rename'',''&FILE_ID.'',''&FILE_TYPE.''); return false;" title="&#37325;&#21629;&#21517;" aria-label="&#37325;&#21629;&#21517;"><span cla'
||'ss="fa fa-pencil" aria-hidden="true"></span></button>',
    '    <button type="button" class="p133-row-action-btn" onclick="p133RunSingleAction(''settings'',''&FILE_ID.'',''&FILE_TYPE.''); return false;" title="&#26435;&#38480;&#35774;&#32622;" aria-label="&#26435;&#38480;&#35774;&#32622;"><span class="fa fa-lock" a'
||'ria-hidden="true"></span></button>',
    '    <button type="button" class="p133-row-action-btn" onclick="p133OpenRowMenu(event,''&FILE_ID.'',''&FILE_TYPE.'',''&IS_PERMISSIONS.''); return false;" title="&#26356;&#22810;&#25805;&#20316;" aria-label="&#26356;&#22810;&#25805;&#20316;"><span class="fa '
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733251)
,p_name=>'FILE_FORMAT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733252)
,p_name=>'SORT_NUM'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733254)
,p_name=>'FILE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733255)
,p_name=>'TYPE_LABEL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733256)
,p_name=>'ICON_CLASS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733257)
,p_name=>'SCOPE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733258)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733259)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733260)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733261)
,p_name=>'OPERATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733262)
,p_name=>'IS_HIDE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733264)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733265)
,p_name=>'IS_FILE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(787632288293733266)
,p_name=>'CAN_OPEN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(787632288293733267)
,p_interactive_grid_id=>wwv_flow_imp.id(787632288293733266)
,p_static_id=>'4686437'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(787632288293733268)
,p_report_id=>wwv_flow_imp.id(787632288293733267)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733269)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(787632288293733245)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>160
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733270)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(787632288293733246)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>136.219
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733271)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(787632288293733259)
,p_is_visible=>false
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733272)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(787632288293733247)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733273)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(787632288293733248)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733274)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(787632288293733249)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733275)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(787632288293733250)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>360
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733276)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(787632288293733251)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>139.195
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733277)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(787632288293733252)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>100
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733279)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(787632288293733254)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733280)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(787632288293733255)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733281)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(787632288293733256)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733282)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(787632288293733257)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733283)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(787632288293733258)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733284)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(787632288293733261)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>250
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733285)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(787632288293733262)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733287)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(787632288293733264)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(787632288293733288)
,p_view_id=>wwv_flow_imp.id(787632288293733268)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(787632288293733265)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(787632288293733244)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(787632288293733297)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(787632288293733242)
,p_button_name=>unistr('\521B\5EFA\6587\4EF6\5939')
,p_button_static_id=>'btn_create_folder'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(9726702811589842046)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(787632288293733298)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(787632288293733296)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(787632288293733302)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_imp.id(787632288293733244)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(787632288293734525)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(787632288293734598)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(787632288293733310)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(787632288293733311)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(787632288293733312)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733315)
,p_name=>'P133_DISPLAY'
,p_item_sequence=>280
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733316)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733318)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733319)
,p_name=>'P133_FILE_ID'
,p_item_sequence=>130
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733320)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733321)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733322)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733323)
,p_name=>'P133_PAGE'
,p_item_sequence=>260
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733325)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733326)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733327)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733328)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293733383)
,p_name=>'P133_SORT_BY'
,p_item_sequence=>340
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293734596)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(787632288293734652)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733329)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733342)
,p_event_id=>wwv_flow_imp.id(787632288293733329)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733343)
,p_event_id=>wwv_flow_imp.id(787632288293733329)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733344)
,p_event_id=>wwv_flow_imp.id(787632288293733329)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733341)
,p_event_id=>wwv_flow_imp.id(787632288293733329)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(787632288293733243)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733330)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733345)
,p_event_id=>wwv_flow_imp.id(787632288293733330)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733346)
,p_event_id=>wwv_flow_imp.id(787632288293733330)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733331)
,p_name=>unistr('\8BBE\7F6E\503C')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(787632288293733296)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733347)
,p_event_id=>wwv_flow_imp.id(787632288293733331)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733348)
,p_event_id=>wwv_flow_imp.id(787632288293733331)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733349)
,p_event_id=>wwv_flow_imp.id(787632288293733331)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733350)
,p_event_id=>wwv_flow_imp.id(787632288293733331)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733351)
,p_event_id=>wwv_flow_imp.id(787632288293733331)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733332)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733352)
,p_event_id=>wwv_flow_imp.id(787632288293733332)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(787632288293733297)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733353)
,p_event_id=>wwv_flow_imp.id(787632288293733332)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733333)
,p_name=>unistr('\521B\5EFA\6587\4EF6\5939')
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(787632288293733297)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733354)
,p_event_id=>wwv_flow_imp.id(787632288293733333)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733355)
,p_event_id=>wwv_flow_imp.id(787632288293733333)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293734597)
,p_event_id=>wwv_flow_imp.id(787632288293733333)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733356)
,p_event_id=>wwv_flow_imp.id(787632288293733333)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733334)
,p_name=>unistr('\4E0A\4F20\6587\4EF6')
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(787632288293733298)
,p_condition_element=>'P133_PARENT_FOLDER_ID'
,p_triggering_condition_type=>'NULL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733357)
,p_event_id=>wwv_flow_imp.id(787632288293733334)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733358)
,p_event_id=>wwv_flow_imp.id(787632288293733334)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733359)
,p_event_id=>wwv_flow_imp.id(787632288293733334)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787632288293733336)
,p_name=>unistr('\884C\9009\4E2D')
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(787632288293733243)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787632288293733366)
,p_event_id=>wwv_flow_imp.id(787632288293733336)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(787632288293733382)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(787632288293733243)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(787632288293734653)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(787632288293734654)
,p_process_sequence=>4
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(787632288293734614)
