...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(940394720336124932)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(940394835481124933)
,p_plug_name=>unistr('\6587\4EF6\7ED3\6784\6811')
,p_parent_plug_id=>wwv_flow_imp.id(940394720336124932)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(938011157336013872)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(940394835481124933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(938011540747013895)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(940394835481124933)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940396800575125062)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940396910841125063)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940398425102125078)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940398551754125079)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(940398643704125080)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(938013978592013957)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(938011157336013872)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(938014462089013973)
,p_event_id=>wwv_flow_imp.id(938013978592013957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(938014830717013976)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(938011540747013895)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(938015375968013978)
,p_event_id=>wwv_flow_imp.id(938014830717013976)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(938016289361013979)
,p_event_id=>wwv_flow_imp.id(938014830717013976)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(938015819688013978)
,p_event_id=>wwv_flow_imp.id(938014830717013976)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(938016872813014007)
,p_event_id=>wwv_flow_imp.id(938014830717013976)
,p_event_result=>'TRUE'
