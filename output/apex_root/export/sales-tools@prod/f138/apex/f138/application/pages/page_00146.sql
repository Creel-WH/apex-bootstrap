...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3521629816656312008)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3521629990916312009)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806772643605440479)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3521629990916312009)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806772318886440479)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3521629990916312009)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806396211742165455)
,p_name=>'P146_FILE_ID'
,p_data_type=>'CLOB'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275601635992419880)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275601841579419882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3521631252540312022)
,p_name=>'P146_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3521629816656312008)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3738618734943375978)
,p_name=>'P146_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3738618799675375979)
,p_name=>'P146_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3738618893357375980)
,p_name=>'P146_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3738619078782375981)
,p_name=>'P146_COUNT'
,p_item_sequence=>160
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3738619382247375985)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3740441735305565614)
,p_name=>'P146_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806775711220440483)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806772318886440479)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806776160953440484)
,p_event_id=>wwv_flow_imp.id(2806775711220440483)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806776559678440484)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806772643605440479)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806777117987440484)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806778136541440485)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806778596060440485)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806398419449165477)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806398310959165476)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806777627163440484)
,p_event_id=>wwv_flow_imp.id(2806776559678440484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806779026479440485)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806779977282440486)
,p_event_id=>wwv_flow_imp.id(2806779026479440485)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2806772643605440479)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806779490682440485)
,p_event_id=>wwv_flow_imp.id(2806779026479440485)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806780345950440486)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806780842875440487)
,p_event_id=>wwv_flow_imp.id(2806780345950440486)
,p_event_result=>'TRUE'
,p_action_sequence=>10
