...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3052760097226146668)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3052760271486146669)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806716636638147631)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3052760271486146669)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2806716227016147631)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3052760271486146669)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806729664622254534)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2806729870209254536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3052760893926146679)
,p_name=>'P136_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3052760097226146668)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3269746763573210632)
,p_name=>'P136_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3269746828305210633)
,p_name=>'P136_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3269746921987210634)
,p_name=>'P136_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>140
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3269747107412210635)
,p_name=>'P136_COUNT'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3269747410877210639)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3271569763935400268)
,p_name=>'P136_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806719321081147637)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806716227016147631)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806719801179147637)
,p_event_id=>wwv_flow_imp.id(2806719321081147637)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806720200376147637)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2806716636638147631)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806720660458147637)
,p_event_id=>wwv_flow_imp.id(2806720200376147637)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806722212381147641)
,p_event_id=>wwv_flow_imp.id(2806720200376147637)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806722726789147642)
,p_event_id=>wwv_flow_imp.id(2806720200376147637)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806721726363147638)
,p_event_id=>wwv_flow_imp.id(2806720200376147637)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806723054408147642)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806724038900147642)
,p_event_id=>wwv_flow_imp.id(2806723054408147642)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2806716636638147631)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806723574881147642)
,p_event_id=>wwv_flow_imp.id(2806723054408147642)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2806724447666147642)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2806724950930147642)
,p_event_id=>wwv_flow_imp.id(2806724447666147642)
,p_event_result=>'TRUE'
,p_action_sequence=>10
