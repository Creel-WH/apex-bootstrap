...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709657207486118148)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709659145216118167)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2807656866336401173)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3709659145216118167)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2807657325427401176)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709657625989118150)
,p_name=>'P204_FEEDBACK_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3709657207486118148)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709657729484118151)
,p_name=>'P204_REMARK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3709657207486118148)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709658882978118162)
,p_name=>'P204_FILE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3709657207486118148)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709660753312118170)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3713982873192653337)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3713983229933653341)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3713983362862653342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3713983411651653343)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807659423622401177)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807659887558401179)
,p_event_id=>wwv_flow_imp.id(2807659423622401177)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807660320416401179)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807660829327401179)
,p_event_id=>wwv_flow_imp.id(2807660320416401179)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807661296095401180)
,p_event_id=>wwv_flow_imp.id(2807660320416401179)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807661785081401180)
,p_event_id=>wwv_flow_imp.id(2807660320416401179)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807662288772401180)
,p_event_id=>wwv_flow_imp.id(2807660320416401179)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807662669354401180)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2807656866336401173)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807663205513401180)
,p_event_id=>wwv_flow_imp.id(2807662669354401180)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CLOSE_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3709657207486118148)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807663608461401180)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2807657325427401176)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807664085642401182)
,p_event_id=>wwv_flow_imp.id(2807663608461401180)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807664547938401182)
,p_event_id=>wwv_flow_imp.id(2807663608461401180)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807666100360401184)
,p_event_id=>wwv_flow_imp.id(2807663608461401180)
,p_event_result=>'TRUE'
...
unistr('    ELSE --\4E0D\9700\8981\66F4\65B0\6587\4EF6'),
'        UPDATE STS_FEEDBACK SET UPDATED_BY = :MPF_USER_ID,UPDATE_DATE = SYSDATE,STATUS = 1,PROCESS_DATE = SYSDATE,PROCESS_USER_ID = :MPF_USER_ID,FEEDBACK_TYPE = :P204_FEEDBACK_TYPE,REMARK = :P204_REMARK WHERE FEEDBACK_ID = :P204_FEEDBACK_ID AND DEL_F'
||'LAG = 0 AND TENANT_ID = :USER_TENANT;',
'    END IF;',
'    V_ROW_COUNT := SQL%ROWCOUNT;',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807665099355401184)
,p_event_id=>wwv_flow_imp.id(2807663608461401180)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807665573553401184)
,p_event_id=>wwv_flow_imp.id(2807663608461401180)
,p_event_result=>'TRUE'
