...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9258742973362615320)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258743313364615321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258743570512615321)
,p_page_template_id=>wwv_flow_imp.id(9258742973362615320)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258743919513615321)
,p_page_template_id=>wwv_flow_imp.id(9258742973362615320)
