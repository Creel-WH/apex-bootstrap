...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258784897317615342)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258785219314615342)
,p_plug_template_id=>wwv_flow_imp.id(9258784897317615342)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258785461531615342)
,p_plug_template_id=>wwv_flow_imp.id(9258784897317615342)
,p_name=>'Sub Regions'
