...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2583946448043274180)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2583946622303274181)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2800931359402338139)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2583946622303274181)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2800931301902338138)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2583946622303274181)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2583946649621274182)
,p_name=>'P125_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2583946448043274180)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800930892579338134)
,p_name=>'P125_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800930957311338135)
,p_name=>'P125_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800931050993338136)
,p_name=>'P125_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>140
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800931236418338137)
,p_name=>'P125_COUNT'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800931523021338140)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2800931539883338141)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2802753892941527770)
,p_name=>'P125_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2800931648383338142)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2800931301902338138)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800931771823338143)
,p_event_id=>wwv_flow_imp.id(2800931648383338142)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2800931842360338144)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2800931359402338139)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2802754030633527771)
,p_event_id=>wwv_flow_imp.id(2800931842360338144)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800932488509338150)
,p_event_id=>wwv_flow_imp.id(2800931842360338144)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2488205996057712783)
,p_event_id=>wwv_flow_imp.id(2800931842360338144)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800932552253338151)
,p_event_id=>wwv_flow_imp.id(2800931842360338144)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800931991086338145)
,p_event_id=>wwv_flow_imp.id(2800931842360338144)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2800932095906338146)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800932226553338147)
,p_event_id=>wwv_flow_imp.id(2800932095906338146)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2800931359402338139)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2803166104694282843)
,p_event_id=>wwv_flow_imp.id(2800932095906338146)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2800932328819338148)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2800932341729338149)
,p_event_id=>wwv_flow_imp.id(2800932328819338148)
,p_event_result=>'TRUE'
,p_action_sequence=>10
