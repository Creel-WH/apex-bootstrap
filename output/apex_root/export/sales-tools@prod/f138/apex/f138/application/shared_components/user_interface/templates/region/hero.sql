...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258815303223615352)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258815631749615352)
,p_plug_template_id=>wwv_flow_imp.id(9258815303223615352)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258815920637615353)
,p_plug_template_id=>wwv_flow_imp.id(9258815303223615352)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258816173193615353)
,p_plug_template_id=>wwv_flow_imp.id(9258815303223615352)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258816489447615353)
,p_plug_template_id=>wwv_flow_imp.id(9258815303223615352)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258816822138615353)
,p_plug_template_id=>wwv_flow_imp.id(9258815303223615352)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
