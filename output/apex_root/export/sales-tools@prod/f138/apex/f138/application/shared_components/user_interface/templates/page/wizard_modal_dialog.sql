...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9258747149106615323)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258747432465615323)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258747737752615323)
,p_page_template_id=>wwv_flow_imp.id(9258747149106615323)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258748054715615323)
,p_page_template_id=>wwv_flow_imp.id(9258747149106615323)
