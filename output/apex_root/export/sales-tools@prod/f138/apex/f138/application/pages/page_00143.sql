...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3273308387646041627)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3273308663834041629)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2807152886012763963)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3273308663834041629)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2807167216602065692)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2807167622367065693)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2807150331346763937)
,p_name=>'P143_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3273308387646041627)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2807153224141763966)
,p_name=>'P143_MESSAGE'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3273309091398041630)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275661131586956012)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3275661207544956013)
,p_name=>'P143_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807168738663065709)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2807167622367065693)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807169237492065710)
,p_event_id=>wwv_flow_imp.id(2807168738663065709)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807169771934065710)
,p_event_id=>wwv_flow_imp.id(2807168738663065709)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807170289333065710)
,p_event_id=>wwv_flow_imp.id(2807168738663065709)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807170794608065711)
,p_event_id=>wwv_flow_imp.id(2807168738663065709)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807171270237065711)
,p_event_id=>wwv_flow_imp.id(2807168738663065709)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2807152997086763964)
,p_name=>unistr('\6267\884C\5F52\6863')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2807152886012763963)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2807153120862763965)
,p_event_id=>wwv_flow_imp.id(2807152997086763964)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
