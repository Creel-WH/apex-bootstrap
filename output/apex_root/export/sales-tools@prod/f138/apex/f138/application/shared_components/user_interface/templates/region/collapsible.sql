...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9258805477774615348)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258805842523615348)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258806150195615349)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258806411014615349)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258806701162615349)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258807030686615349)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258807288422615350)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258807644073615350)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258807901668615350)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258808206182615350)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9258808461243615350)
,p_plug_template_id=>wwv_flow_imp.id(9258805477774615348)
,p_name=>'Sub Regions'
