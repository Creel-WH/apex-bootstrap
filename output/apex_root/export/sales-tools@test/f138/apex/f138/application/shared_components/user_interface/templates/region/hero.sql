...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10249585185297239714)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249585513823239714)
,p_plug_template_id=>wwv_flow_imp.id(10249585185297239714)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249585802711239715)
,p_plug_template_id=>wwv_flow_imp.id(10249585185297239714)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249586055267239715)
,p_plug_template_id=>wwv_flow_imp.id(10249585185297239714)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249586371521239715)
,p_plug_template_id=>wwv_flow_imp.id(10249585185297239714)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10249586704212239715)
,p_plug_template_id=>wwv_flow_imp.id(10249585185297239714)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
