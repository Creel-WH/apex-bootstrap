...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(6923993344902112817)
,p_lov_name=>unistr('REQ_TYPE\FF08\9700\6C42\7C7B\578B\FF09')
,p_lov_query=>'.'||wwv_flow_imp.id(6923993344902112817)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(6923993652552112824)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'BUG'
,p_lov_return_value=>'0'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(6923994047861112825)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>unistr('\65B0\9700\6C42')
,p_lov_return_value=>'5'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(6923994411269112826)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>unistr('\529F\80FD\8FED\4EE3\4F18\5316')
,p_lov_return_value=>'10'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(6923994820383112826)
