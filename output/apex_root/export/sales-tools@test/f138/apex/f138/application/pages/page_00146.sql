...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4512399698729936370)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4512399872989936371)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3797542525679064841)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4512399872989936371)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3797542200960064841)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4512399872989936371)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3797166093815789817)
,p_name=>'P146_FILE_ID'
,p_data_type=>'CLOB'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266371518066044242)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4266371723653044244)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4512401134613936384)
,p_name=>'P146_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4512399698729936370)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4729388617017000340)
,p_name=>'P146_URL'
,p_data_type=>'CLOB'
,p_item_sequence=>120
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4729388681749000341)
,p_name=>'P146_NAME'
,p_data_type=>'CLOB'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4729388775431000342)
,p_name=>'P146_TYPE'
,p_data_type=>'CLOB'
,p_item_sequence=>150
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4729388960856000343)
,p_name=>'P146_COUNT'
,p_item_sequence=>160
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4729389264321000347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4731211617379189976)
,p_name=>'P146_SIZE'
,p_data_type=>'CLOB'
,p_item_sequence=>180
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797545593294064845)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3797542200960064841)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797546043027064846)
,p_event_id=>wwv_flow_imp.id(3797545593294064845)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797546441752064846)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3797542525679064841)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797547000061064846)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797548018615064847)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797548478134064847)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797168301522789839)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797168193032789838)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797547509237064846)
,p_event_id=>wwv_flow_imp.id(3797546441752064846)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797548908553064847)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797549859356064848)
,p_event_id=>wwv_flow_imp.id(3797548908553064847)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_ENABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3797542525679064841)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797549372756064847)
,p_event_id=>wwv_flow_imp.id(3797548908553064847)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3797550228024064848)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3797550724949064849)
,p_event_id=>wwv_flow_imp.id(3797550228024064848)
,p_event_result=>'TRUE'
,p_action_sequence=>10
