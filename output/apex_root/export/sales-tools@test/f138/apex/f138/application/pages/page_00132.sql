...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3782154377398290828)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3782154632971290831)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3782155010369290834)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3782154632971290831)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3782154869245290833)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3782154632971290831)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3782154451064290829)
,p_name=>'P132_FILE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3782154377398290828)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3782154519610290830)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3782154735915290832)
,p_name=>'P132_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3782155450641290839)
,p_name=>'P132_COUNT'
,p_item_sequence=>140
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3782155064149290835)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3782154869245290833)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3782155135960290836)
,p_event_id=>wwv_flow_imp.id(3782155064149290835)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3782155233212290837)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3782155010369290834)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3782155680859290841)
,p_event_id=>wwv_flow_imp.id(3782155233212290837)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3782155599399290840)
,p_event_id=>wwv_flow_imp.id(3782155233212290837)
,p_event_result=>'TRUE'
...
'        UPDATED_BY =NVL(:MPF_USER_ID, :USER_ID),',
'        UPDATE_DATE=SYSDATE',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3793493702022846397)
,p_event_id=>wwv_flow_imp.id(3782155233212290837)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3782155354574290838)
,p_event_id=>wwv_flow_imp.id(3782155233212290837)
,p_event_result=>'TRUE'
