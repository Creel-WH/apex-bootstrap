...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9731582596735394024)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731582952798394024)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731583269969394024)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731583481651394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731583850787394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731584112444394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731584411870394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731584717382394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731585011224394025)
,p_plug_template_id=>wwv_flow_imp.id(9731582596735394024)
,p_name=>'Sub Regions'
