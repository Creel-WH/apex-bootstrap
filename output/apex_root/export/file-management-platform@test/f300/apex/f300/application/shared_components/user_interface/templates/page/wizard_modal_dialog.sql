...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9731510968155393994)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731511251514393994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731511556801393994)
,p_page_template_id=>wwv_flow_imp.id(9731510968155393994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731511873764393994)
,p_page_template_id=>wwv_flow_imp.id(9731510968155393994)
