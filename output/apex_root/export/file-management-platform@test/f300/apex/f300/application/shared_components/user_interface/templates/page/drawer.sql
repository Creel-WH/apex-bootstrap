...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9731499941614393973)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731500244901393981)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731500546368393982)
,p_page_template_id=>wwv_flow_imp.id(9731499941614393973)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9731500875055393982)
,p_page_template_id=>wwv_flow_imp.id(9731499941614393973)
