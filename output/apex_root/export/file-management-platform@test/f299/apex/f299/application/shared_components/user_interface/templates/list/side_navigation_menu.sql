...
'</div>',
'<style>',
'#t_Body_nav{background:#fff;border-right:1px solid #e8e8e8;box-shadow:none;color:#666}#t_TreeNav{padding:10px 0}#t_Body_nav .a-TreeView-content,#t_Body_nav .a-TreeView-content *{color:#666!important}#t_TreeNav .a-TreeView-row{display:none!important}#t_TreeNav .a-TreeView-content{margin:2px 12px;padding:10px 14px;border-radius:8px;color:#666!important}#t_TreeNav .a-TreeView-content:hover{background:#f0f7ff!important}#t_TreeNav .a-TreeView-content:hover,#t_TreeNav .a-TreeView-content:hover *{color:#1890ff!important}#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content{background:#e6f7ff!important;color:#1890ff!important}#t_TreeNav li[data-current="true"]>.a-TreeView-node>.a-TreeView-content *,#t_TreeNav .a-TreeView-node.is-selected>.a-TreeView-content *,#t_TreeNav .a-TreeView-node.is-current>.a-TreeView-content *{color:#1890ff!important}#t_TreeNav ul[role="group"]{background:#fff!important;margin:0;padding:4px 0 8px}#t_TreeNav ul[role="group"] .a-TreeView-content{margin:2px 12px;padding:10px 14px 10px 36px;border-radius:8px;background:#fff!important}#t_TreeNav ul[role="group"] .a-TreeView-content:hover{background:#f5f7fa!important}',
'</style>',
'<script>',
'(() => {',
