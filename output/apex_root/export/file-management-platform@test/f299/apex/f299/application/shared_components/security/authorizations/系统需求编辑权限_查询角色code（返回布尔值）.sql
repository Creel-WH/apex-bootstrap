...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3745089362415392174)
...
'BEGIN',
unistr('  -- \76F4\63A5\6839\636E\5F53\524D\4F1A\8BDD\89D2\8272CODE\5224\65AD'),
'  IF NVL(:ROLE_CODE, ''VIEW_REPORT'') <> ''VIEW_REPORT'' THEN',
'    RETURN TRUE;',
'  ELSE',
'    RETURN FALSE;',
'  END IF;',
