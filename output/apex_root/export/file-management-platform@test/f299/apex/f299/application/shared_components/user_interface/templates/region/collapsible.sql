...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9760052865210264240)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760053229959264240)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760053537631264241)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760053798450264241)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760054088598264241)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760054418122264241)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760054675858264242)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760055031509264242)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760055289104264242)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760055593618264242)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760055848679264242)
,p_plug_template_id=>wwv_flow_imp.id(9760052865210264240)
,p_name=>'Sub Regions'
