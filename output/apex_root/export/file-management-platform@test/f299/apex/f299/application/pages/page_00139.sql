...
'FROM FMP_SCOPE A ',
'         LEFT JOIN FMP_FILE B ON A.REFERENCE_TYPE = ''FILE'' AND A.REFERENCE_ID =B.FILE_ID',
...
'BEGIN',
'    SELECT IS_PERMISSION_CHANGES INTO V_PERMISSION_CHANGES FROM FMP_FILE WHERE FILE_ID = :P139_FILE_ID;',
'',
...
,p_item_sequence=>160
,p_item_default=>'select FILE_NAME from FMP_FILE where  FILE_ID  = :P139_FILE_ID;'
...
,p_item_default=>'select SCOPE_TYPE from FMP_FILE where  FILE_ID  = :P139_FILE_ID;'
,p_item_default_type=>'SQL_QUERY'
...
'    ',
'delete FMP_SCOPE where REFERENCE_TYPE =''FILE'' AND REFERENCE_ID =ITEM.FILE_ID;',
'',
'insert into FMP_SCOPE (CREATED_BY,',
'                       UPDATED_BY,',
'                       RANGE_TYPE,',
...
'                                          AND PRIOR DEL_FLAG <> 1',
'                                          AND IS_PERMISSION_CHANGES = 0);',
'            FMP_SYNCHRONIZE_ACCOUNTS_DELETE_PRO(V_RANGE_TYPE, V_RANGE_ID, :MPF_USER_ID, :USER_TENANT, ITEM.DATA_VAL);',
'        END LOOP;',
'    APEX_UTIL.SET_SESSION_STATE(''P139_ROW_COUNT'', 1);',
'    COMMIT;',
'EXCEPTION',
...
'            WHERE SCOPE_ID = ITEM.DATA_VAL;',
'',
'            DELETE FMP_SCOPE WHERE SCOPE_ID = ITEM.DATA_VAL;',
'',
'            DELETE FMP_SCOPE',
'            WHERE REFERENCE_TYPE = ''FILE''',
'              AND RANGE_TYPE = V_RANGE_TYPE',
...
'FROM DUAL;',
'SELECT PERMISSIONS_TYPE INTO V_PERMISSIONS_TYPE_OLB  from FMP_SCOPE where SCOPE_ID =V_SCOPE_ID;',
unistr('IF V_PERMISSIONS_TYPE = ''MANAGE'' AND V_PERMISSIONS_TYPE_OLB <>V_PERMISSIONS_TYPE THEN --\7BA1\7406\6743\9650'),
'FMP_SYNCHRONIZE_ACCOUNTS_PRO(V_RANGE_TYPE, V_RANGE_ID, :MPF_USER_ID, :USER_TENANT);',
...
'    UPDATE_DATE      =SYSDATE',
'WHERE SCOPE_ID = V_SCOPE_ID;',
unistr('UPDATE FMP_SCOPE --\4E0B\7EA7\6743\9650'),
'SET PERMISSIONS_TYPE = V_PERMISSIONS_TYPE,',
'    UPDATED_BY       = :MPF_USER_ID,',
'    UPDATE_DATE      =SYSDATE',
'WHERE REFERENCE_TYPE = ''FILE''',
...
'--             FMP_SYNCHRONIZE_ACCOUNTS_DELETE_PRO(:RANGE_TYPE, :RANGE_ID, :MPF_USER_ID, :USER_TENANT,''FILE'',:SCOPE_ID);',
'',
unistr('            IF :PERMISSIONS_TYPE = ''MANAGE'' THEN --\7BA1\7406\6743\9650'),
'                FMP_SYNCHRONIZE_ACCOUNTS_PRO(:RANGE_TYPE, :RANGE_ID, :MPF_USER_ID, :USER_TENANT);',
unistr('                --\6587\4EF6\5E93'),
'                UPDATE FMP_SCOPE',
...
'                    UPDATE_DATE      =SYSDATE',
'                WHERE  REFERENCE_TYPE =''FILE''',
'                    AND REFERENCE_ID IN (SELECT FILE_ID FROM FMP_FILE WHERE ROOT_FOLDER_ID =:REFERENCE_ID);',
'            ELSE',
unistr('                --\6587\4EF6\5E93'),
'                UPDATE FMP_SCOPE',
'                SET PERMISSIONS_TYPE = :PERMISSIONS_TYPE,',
