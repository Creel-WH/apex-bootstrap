...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9760032284753264234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760032606750264234)
,p_plug_template_id=>wwv_flow_imp.id(9760032284753264234)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760032848967264234)
,p_plug_template_id=>wwv_flow_imp.id(9760032284753264234)
,p_name=>'Sub Regions'
