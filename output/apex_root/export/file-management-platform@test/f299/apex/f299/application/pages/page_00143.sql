...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3774555775081690519)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3774556051269690521)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3308400273448412855)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3774556051269690521)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3308414604037714584)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3308415009802714585)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3308397718782412829)
,p_name=>'P143_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3774555775081690519)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3308400611577412858)
,p_name=>'P143_MESSAGE'
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3774556478833690522)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3776908519022604904)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3776908594980604905)
,p_name=>'P143_FILE_ID'
,p_item_sequence=>130
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308416126098714601)
,p_name=>unistr('\8BBE\7F6E\9ED8\8BA4\5F52\6863\65F6\95F4')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3308415009802714585)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308416624927714602)
,p_event_id=>wwv_flow_imp.id(3308416126098714601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308417159369714602)
,p_event_id=>wwv_flow_imp.id(3308416126098714601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308417676768714602)
,p_event_id=>wwv_flow_imp.id(3308416126098714601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308418182043714603)
,p_event_id=>wwv_flow_imp.id(3308416126098714601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308418657672714603)
,p_event_id=>wwv_flow_imp.id(3308416126098714601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3308400384522412856)
,p_name=>unistr('\6267\884C\5F52\6863')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3308400273448412855)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3308400508298412857)
,p_event_id=>wwv_flow_imp.id(3308400384522412856)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
