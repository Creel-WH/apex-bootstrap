...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3292630219786315341)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3292630283116315342)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3292630548933315345)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3292630283116315342)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3292630473112315344)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3292630283116315342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3292630354594315343)
,p_name=>'P131_FILE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3292630219786315341)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3292631184526315351)
,p_name=>'P131_COUNT'
,p_item_sequence=>120
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3292630686953315346)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3292630473112315344)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3292630817017315347)
,p_event_id=>wwv_flow_imp.id(3292630686953315346)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3292630875829315348)
,p_name=>unistr('\786E\5B9A')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3292630548933315345)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3292631252284315352)
,p_event_id=>wwv_flow_imp.id(3292630875829315348)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3292631046469315350)
,p_event_id=>wwv_flow_imp.id(3292630875829315348)
,p_event_result=>'TRUE'
...
'            ''FILE'',',
'            ''USER'',',
'            COALESCE((SELECT MAX(ext_user_id)',
'                        FROM FMP_USER',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3292631431660315354)
,p_event_id=>wwv_flow_imp.id(3292630875829315348)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3292630980283315349)
,p_event_id=>wwv_flow_imp.id(3292630875829315348)
,p_event_result=>'TRUE'
