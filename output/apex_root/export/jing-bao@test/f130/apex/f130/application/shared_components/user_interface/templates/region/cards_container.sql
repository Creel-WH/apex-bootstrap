...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2302029553726836195)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2164046911508287599)
,p_plug_template_id=>wwv_flow_imp.id(2302029553726836195)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2164046981783287599)
,p_plug_template_id=>wwv_flow_imp.id(2302029553726836195)
,p_name=>'Sub Regions'
