...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2684710161452511425)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2684714022173511433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2409106094723334677)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2684714022173511433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2409106512980334677)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2409106921209334677)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409101107470334673)
,p_name=>'P251_CLASSIFY_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2684710161452511425)
,p_item_source_plug_id=>wwv_flow_imp.id(2684710161452511425)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409101482632334674)
,p_name=>'P251_NAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409101917366334674)
,p_name=>'P251_REMARK'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2684710161452511425)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409102266477334674)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409102721698334674)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2409103109915334674)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2409107673504334685)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2409106094723334677)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409108144990334685)
,p_event_id=>wwv_flow_imp.id(2409107673504334685)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2409108564881334685)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2409106512980334677)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409109638345334686)
,p_event_id=>wwv_flow_imp.id(2409108564881334685)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409110078641334686)
,p_event_id=>wwv_flow_imp.id(2409108564881334685)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409110558071334687)
,p_event_id=>wwv_flow_imp.id(2409108564881334685)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409109087711334686)
,p_event_id=>wwv_flow_imp.id(2409108564881334685)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2409110975930334687)
,p_name=>unistr('\65B0\5EFA')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2409106921209334677)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409111497445334687)
,p_event_id=>wwv_flow_imp.id(2409110975930334687)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>unistr('\53C2\6570\6821\9A8C')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409112034069334688)
,p_event_id=>wwv_flow_imp.id(2409110975930334687)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409112540346334688)
,p_event_id=>wwv_flow_imp.id(2409110975930334687)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2409113019451334688)
,p_event_id=>wwv_flow_imp.id(2409110975930334687)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2409105412570334676)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2684710161452511425)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2409107304509334685)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2409104999976334676)
,p_process_sequence=>10
