...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2167168194658933135)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2167168572047933135)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2167168194658933135)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2167170220862933137)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2167170536299933137)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2167170986782933138)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167163389258933130)
,p_name=>'P112_EVENT_CATEGORY_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2167162980115933129)
,p_item_source_plug_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167163698848933131)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167164106456933132)
,p_name=>'P112_PNAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167164509938933133)
,p_name=>'P112_CODE'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167164868240933133)
,p_name=>'P112_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>70
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167165288211933133)
,p_name=>'P112_SNAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167165658882933133)
,p_name=>'P112_SCODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2167177685768965414)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2167168671182933135)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2167168572047933135)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167169457976933136)
,p_event_id=>wwv_flow_imp.id(2167168671182933135)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2259534542920145359)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2167170536299933137)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2259534694776145360)
,p_event_id=>wwv_flow_imp.id(2259534542920145359)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2259534796500145361)
,p_event_id=>wwv_flow_imp.id(2259534542920145359)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2167177451607965412)
,p_name=>unistr('\521B\5EFA')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2167170986782933138)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167177556623965413)
,p_event_id=>wwv_flow_imp.id(2167177451607965412)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167177814140965415)
,p_event_id=>wwv_flow_imp.id(2167177451607965412)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167177884170965416)
,p_event_id=>wwv_flow_imp.id(2167177451607965412)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2167179181684965429)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167179319868965430)
,p_event_id=>wwv_flow_imp.id(2167179181684965429)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2167179704235965434)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2167179793546965435)
,p_event_id=>wwv_flow_imp.id(2167179704235965434)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168578845101136237)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168578981324136238)
,p_event_id=>wwv_flow_imp.id(2168578845101136237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2167172141360933139)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2167171374802933139)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(2167162980115933129)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2259534450633145358)
,p_process_sequence=>10
