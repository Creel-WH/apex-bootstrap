...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2166222154217500623)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2166222601376500622)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2166222956590500622)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166223337996500619)
,p_name=>'P186_MOBILE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166223749612500618)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166224193939500618)
,p_name=>'P186_CODE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166224558242500618)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166224995729500617)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166225412801500617)
,p_name=>'P186_FLAG'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2166225819097500617)
,p_name=>'P186_USER_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(2171930789351743191)
,p_item_source_plug_id=>wwv_flow_imp.id(2171930789351743191)
,p_source=>'USER_ID'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2166227780938500611)
...
,p_associated_item=>wwv_flow_imp.id(2166224995729500617)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2166228453745500610)
,p_name=>unistr('\53D1\9001\9A8C\8BC1\7801')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2166222154217500623)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166228966907500609)
,p_event_id=>wwv_flow_imp.id(2166228453745500610)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166229472653500609)
,p_event_id=>wwv_flow_imp.id(2166228453745500610)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166229986608500609)
,p_event_id=>wwv_flow_imp.id(2166228453745500610)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166230482250500608)
,p_event_id=>wwv_flow_imp.id(2166228453745500610)
,p_event_result=>'TRUE'
...
,p_affected_button_id=>wwv_flow_imp.id(2166222154217500623)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2166230841934500608)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166231343227500608)
,p_event_id=>wwv_flow_imp.id(2166230841934500608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2166231776482500608)
,p_name=>unistr('\53D6\6D88')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2166222601376500622)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166232235298500608)
,p_event_id=>wwv_flow_imp.id(2166231776482500608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2166232708852500608)
,p_name=>unistr('\4FDD\5B58')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2166222956590500622)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166233131628500607)
,p_event_id=>wwv_flow_imp.id(2166232708852500608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166233630229500607)
,p_event_id=>wwv_flow_imp.id(2166232708852500608)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166234139759500607)
,p_event_id=>wwv_flow_imp.id(2166232708852500608)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2166234647141500607)
,p_event_id=>wwv_flow_imp.id(2166232708852500608)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2166226911961500614)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2171930789351743191)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2166228028628500610)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2166226498051500615)
,p_process_sequence=>10
