...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2176051160977638631)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2176057927204638638)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2176058305321638638)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2176057927204638638)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2176060057837638639)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2176060435860638640)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2173822441223690644)
,p_name=>'P175_ROW_COUNT'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(2176051160977638631)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176051617107638632)
,p_name=>'P175_FRONT_LINE_POLICY_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2176051160977638631)
,p_item_source_plug_id=>wwv_flow_imp.id(2176051160977638631)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176052014852638634)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176052418767638634)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176052761574638634)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176053157382638635)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176053586825638635)
,p_name=>'P175_REMARK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176053943906638635)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176054377671638635)
,p_name=>'P175_POLICY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176054749545638635)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2176058390341638638)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2176058305321638638)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176059152466638639)
,p_event_id=>wwv_flow_imp.id(2176058390341638638)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2173821998286690639)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822113575690640)
,p_event_id=>wwv_flow_imp.id(2173821998286690639)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2173822169071690641)
,p_name=>unistr('\4FEE\6539')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2176060057837638639)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822291092690642)
,p_event_id=>wwv_flow_imp.id(2173822169071690641)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822405963690643)
,p_event_id=>wwv_flow_imp.id(2173822169071690641)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822564984690645)
,p_event_id=>wwv_flow_imp.id(2173822169071690641)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822652639690646)
,p_event_id=>wwv_flow_imp.id(2173822169071690641)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2173822728905690647)
,p_name=>unistr('\65B0\589E')
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2176060435860638640)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173822870654690648)
,p_event_id=>wwv_flow_imp.id(2173822728905690647)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173823018712690649)
,p_event_id=>wwv_flow_imp.id(2173822728905690647)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173823069808690650)
,p_event_id=>wwv_flow_imp.id(2173822728905690647)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2173823134332690651)
,p_event_id=>wwv_flow_imp.id(2173822728905690647)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2176061305680638640)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2176051160977638631)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2176061680300638640)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2176060897042638640)
,p_process_sequence=>10
