...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(383861182303981311)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(370373387558176572)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(370373507181176573)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(370373559383176574)
,p_event_id=>wwv_flow_imp.id(370373507181176573)
,p_event_result=>'TRUE'
