...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2165669368015037094)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2165676062184037102)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2165676513256037102)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2165676062184037102)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2165678646724037104)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165669812557037096)
,p_name=>'P146_FILE_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2165669368015037094)
,p_item_source_plug_id=>wwv_flow_imp.id(2165669368015037094)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165670134884037097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165670533182037098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165670933778037099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165671383354037099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165671820089037099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165672187501037099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165672566450037099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2165672975994037100)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176272503625596018)
,p_name=>'P146_FNAME'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(2165669368015037094)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2176272578074596019)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2165676581813037102)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2165676513256037102)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2165677417254037103)
,p_event_id=>wwv_flow_imp.id(2165676581813037102)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2176273298059596026)
,p_name=>unistr('\4E0A\4F20')
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2165678646724037104)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2169907338455032236)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176273777227596031)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176273415934596027)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176273500211596028)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176273561822596029)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2176273645696596030)
,p_event_id=>wwv_flow_imp.id(2176273298059596026)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2165679433965037106)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2165669368015037094)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2165679903275037106)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2165679089437037105)
,p_process_sequence=>10
