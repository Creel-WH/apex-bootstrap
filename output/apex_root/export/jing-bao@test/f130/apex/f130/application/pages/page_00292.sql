...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(571529198533802322)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(571529299951802323)
,p_name=>unistr('\5207\6362\7EC4\7EC7')
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(571529358725802324)
,p_event_id=>wwv_flow_imp.id(571529299951802323)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(571529420066802325)
,p_event_id=>wwv_flow_imp.id(571529299951802323)
,p_event_result=>'TRUE'
