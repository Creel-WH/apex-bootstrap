...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2181794381247092672)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2181794601553092674)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168089748279405903)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2181794601553092674)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2168090191378405902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2142131297376811352)
,p_name=>'P200_FLAG'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2181794381247092672)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168088265181405906)
,p_name=>'P200_CONTEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2181794381247092672)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168088646644405905)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2168089120001405904)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168090625807405896)
,p_name=>unistr('\4E0D\901A\8FC7')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168089748279405903)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168091110725405895)
,p_event_id=>wwv_flow_imp.id(2168090625807405896)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168091551400405895)
,p_event_id=>wwv_flow_imp.id(2168090625807405896)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168092060296405894)
,p_event_id=>wwv_flow_imp.id(2168090625807405896)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168092540493405894)
,p_event_id=>wwv_flow_imp.id(2168090625807405896)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2168092950849405894)
,p_name=>unistr('\901A\8FC7')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2168090191378405902)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168093433840405894)
,p_event_id=>wwv_flow_imp.id(2168092950849405894)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168093949559405894)
,p_event_id=>wwv_flow_imp.id(2168092950849405894)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168094524795405894)
,p_event_id=>wwv_flow_imp.id(2168092950849405894)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2168094933399405893)
,p_event_id=>wwv_flow_imp.id(2168092950849405894)
,p_event_result=>'TRUE'
