...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421789549619171855)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421789805989171855)
,p_plug_template_id=>wwv_flow_imp.id(4421789549619171855)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421790165328171855)
,p_plug_template_id=>wwv_flow_imp.id(4421789549619171855)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421790440256171855)
,p_plug_template_id=>wwv_flow_imp.id(4421789549619171855)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421790707584171855)
,p_plug_template_id=>wwv_flow_imp.id(4421789549619171855)
,p_name=>'Sub Regions'
