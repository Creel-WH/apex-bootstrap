...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421849510296171878)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421849796270171878)
,p_plug_template_id=>wwv_flow_imp.id(4421849510296171878)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421850091590171878)
,p_plug_template_id=>wwv_flow_imp.id(4421849510296171878)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421850463568171878)
,p_plug_template_id=>wwv_flow_imp.id(4421849510296171878)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421850770504171878)
,p_plug_template_id=>wwv_flow_imp.id(4421849510296171878)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421851072015171878)
,p_plug_template_id=>wwv_flow_imp.id(4421849510296171878)
,p_name=>'Sub Regions'
