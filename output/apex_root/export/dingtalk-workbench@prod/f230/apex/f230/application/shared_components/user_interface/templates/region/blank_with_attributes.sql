...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421788139356171854)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421788395285171854)
,p_plug_template_id=>wwv_flow_imp.id(4421788139356171854)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421788759549171854)
,p_plug_template_id=>wwv_flow_imp.id(4421788139356171854)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421789008660171854)
,p_plug_template_id=>wwv_flow_imp.id(4421788139356171854)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421789342512171855)
,p_plug_template_id=>wwv_flow_imp.id(4421788139356171854)
,p_name=>'Sub Regions'
