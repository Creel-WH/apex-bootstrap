...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421844906972171876)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421845214758171877)
,p_plug_template_id=>wwv_flow_imp.id(4421844906972171876)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421845523887171877)
,p_plug_template_id=>wwv_flow_imp.id(4421844906972171876)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421845851822171877)
,p_plug_template_id=>wwv_flow_imp.id(4421844906972171876)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421846157678171877)
,p_plug_template_id=>wwv_flow_imp.id(4421844906972171876)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421846432192171877)
,p_plug_template_id=>wwv_flow_imp.id(4421844906972171876)
,p_name=>'Sub Regions'
