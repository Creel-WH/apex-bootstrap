...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4421839536699171874)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421839866854171874)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421840096813171874)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421840391264171874)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421840756413171874)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421841055414171874)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421841295986171875)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421841596423171875)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4421841898118171875)
,p_plug_template_id=>wwv_flow_imp.id(4421839536699171874)
,p_name=>'Sub Regions'
